...
import {
  ...
  h,
  r
} from "./chunk-KIUCZWNL.js";
import {
  u
} from "./chunk-PYSGLS6T.js";
import "./chunk-RSAA5MM2.js";
import {
  t as t3
} from "./chunk-A4WWQFVE.js";
import {
  o as o2
} from "./chunk-EDEY55HC.js";
import {
  e as e3
} from "./chunk-T3FBTHTT.js";
import {
  F,
  It,
  Lt,
  ...
  lt,
  st
} from "./chunk-IUNMUO77.js";
import "./chunk-WVJBRJAC.js";
import {
  f,
  p as p2,
  v,
...
import {
  ...
  c,
  n as n2
} from "./chunk-44QIFZWV.js";
import "./chunk-U7474U4J.js";
import {
  Ae as Ae2,
  Gt,
  Zt
...
import {
  ...
  j,
  w
} from "./chunk-THOXRTWR.js";
import "./chunk-6ALJKUE3.js";
import "./chunk-ELF4IIHE.js";
import {
  A,
  E as E2,
  O,
  w as w3
} from "./chunk-RSTXVXT3.js";
import "./chunk-V45C7BLJ.js";
import {
  m
} from "./chunk-FBIYHBUT.js";
...
var pt = { after: (e4, t4) => dt(e4) ? e4.slice(t4.length) : "" === t4 ? e4 : e4.slice(t4.length + 1), concat: (e4, t4) => dt(e4) ? (e4 = [...e4], t4 && e4.push(t4), e4) : t4 && void 0 !== t4.toString ? ("" !== e4 && (e4 += ot), ut(t4) ? e4 + t4.toString() : e4 + t4) : e4, initial: (e4) => {
...
function mt(e4, t4, n3) {
  return e4.isUnsubscribed || t4.ignoreSymbols && ut(n3) || t4.ignoreUnderscores && "_" === n3.charAt(0) || "ignoreKeys" in t4 && t4.ignoreKeys.includes(n3);
}
var ft = class {
  constructor(e4) {
...
var Gt2 = class {
  ...
  start(e4, t4, n3) {
    let i2 = Rt;
    dt(e4) ? i2 = Tt : e4 instanceof Date ? i2 = Dt : e4 instanceof Set ? i2 = Vt : e4 instanceof Map ? i2 = Lt2 : e4 instanceof WeakSet ? i2 = It2 : e4 instanceof WeakMap && (i2 = Ut), this._stack.push(new i2(e4, t4, n3, this._hasOnValidate));
  }
  update(e4, t4, n3) {
    this._stack[this._stack.length - 1].update(e4, t4, n3);
  }
  preferredThisArg(e4, t4, n3) {
    let { name: i2 } = e4, s6 = Gt2.isHandledMethod(n3, i2);
...
var Nt = (e4, t4, n3 = {}) => {
  n3 = { ...Bt2, ...n3 };
  let i2 = Symbol("ProxyTarget"), { equals: s6, isShallow: r5, ignoreDetached: a2, details: o4 } = n3, l2 = new ft(s6), c2 = "function" == typeof n3.onValidate, h3 = new Gt2(c2), d = (e5, t5, i3, s7, r6) => !c2 || h3.isCloning || true === n3.onValidate(pt.concat(l2.getPath(e5), t5), i3, s7, r6), u2 = (t5, i3, s7, r6) => {
  ...
  }(t5) || "constructor" === o5 || r5 && !Gt2.isHandledMethod(s7, o5) || mt(l2, n3, o5) || l2.isGetInvariant(s7, o5) || a2 && l2.isDetached(s7, e4) ? t5 : (void 0 === c3 && (c3 = l2.getPath(s7)), l2.getProxy(t5, pt.concat(c3, o5), v2, i2)), v2 = { get(e5, t5, n4) {
    if (ut(t5)) {
      if (t5 === i2 || t5 === lt2) return e5;
      if (t5 === ct2 && !l2.isUnsubscribed && 0 === l2.getPath(e5).length) return l2.unsubscribe(), e5;
    }
    ...
    if ((false === o4 || true !== o4 && !o4.includes(t5.name)) && Gt2.isHandledType(a3)) {
      let i3 = pt.initial(l2.getPath(t5)), o5 = Gt2.isHandledMethod(a3, t5.name);
      h3.start(a3, i3, r6);
      let c3 = Reflect.apply(t5, h3.preferredThisArg(t5, n4, a3), o5 ? r6.map((e5) => m3(e5)) : r6), u3 = h3.isChanged(a3, s6), y3 = h3.stop();
      if (Gt2.isHandledType(c3) && o5 && (n4 instanceof Map && "get" === t5.name && (i3 = pt.concat(i3, r6[0])), c3 = l2.getProxy(c3, i3, v2)), u3) {
...
Nt.target = (e4) => e4 && e4[lt2] || e4, Nt.unsubscribe = (e4) => e4[ct2] || e4;
var Kt = Nt;
...
function Yt3(e4) {
  ...
  if ("SubdivGeometry" === t4.type) {
    ...
    let s7 = { type: e5, ...Zt3(n4.positionWASM.array) };
...
var Jt2 = new Ki();
function Zt3(e4) {
  return Xt2.setFromArray(e4), Xt2.getSize(Jt2), { width: Jt2.x, height: Jt2.y, depth: Jt2.z };
}
var Qt2 = class {
  constructor(e4, t4, n3, i2, s6, r5) {
    ...
    this.actions = O(t4, t4.actions, i2, s6, r5, n3);
  }
  disconnect() {
    w3(this.actions);
  }
...
var en = class extends s4 {
  ...
  connect() {
    ...
    e4.traverseEntity((e5) => {
      var _a2;
      (s2(e5) || e5 instanceof X) && ((_a2 = e5.frame) == null ? void 0 : _a2.traverse((t5) => {
        i2(t5, e5);
      })), i2(e5);
...
var an = class {
  constructor(e4, t4, n3, i2, s6, r5) {
    this.id = e4, this.data = t4, this.object = n3, this.actions = O(t4, t4.actions, i2, s6, r5, n3);
  }
  disconnect() {
    w3(this.actions);
  }
...
var on = class extends s4 {
  ...
  connect() {
    ...
    if (t4.traverseEntity((e5) => {
      var _a;
      (s2(e5) || e5 instanceof X) && ((_a = e5.frame) == null ? void 0 : _a.traverse((e6) => {
        n3(e6);
      })), n3(e5);
...
var fn = class {
  ...
  resetPersonalCameraFromDocumentData() {
    for (let e4 of this.scene.children) e4 instanceof X && !e4.uiScene && e4.personalCamera.updateState(e4.data.camera, { scene: this.scene, shared: this.shared });
  }
  dispose() {
...
function vn(e4) {
  return mn || (mn = import("./runtime-DRACOLoader-GLMRFFK2-KIBT7YWD.js").then(({ DRACOLoader: t4 }) => ((pn = new t4()).setDecoderPath(void 0 !== e4 ? `${e4}/` : "https://www.gstatic.com/draco/versioned/decoders/1.5.2/").preload(), pn.decoderPending))), mn;
}
...
var _n = { bloom: () => import("./runtime-bloom-XL2LGMRS-HWGXYV6W.js"), chromaticAberration: () => import("./runtime-chromaticAberration-G6RI2BZ6-YQITD244.js"), vignette: () => import("./runtime-vignette-TECYHVQU-FAWNELBU.js"), noise: () => import("./runtime-noise-PNVGOS7A-YKQMVR62.js"), hueSaturation: () => import("./runtime-hueSaturation-LYCL2TIK-T5CM2GJM.js"), brightnessContrast: () => import("./runtime-brightnessContrast-NVUYXHJN-AJC56QJL.js"), depthOfField: () => import("./runtime-depthOfField-UOGP3RXR-ZE72GVTW.js"), pixelation: () => import("./runtime-pixelation-ZVCDH6UI-6NW47XUH.js") };
var jn = { bloom: () => import("./runtime-fxBloom-7MH75D7M-PPLK3KKA.js"), depthOfField: () => import("./runtime-fxDepthOfField-TFTNDBM5-WELFHKRV.js") };
...
var kn = class {
  ...
  static mount(e4, t4, n3, i2) {
    ...
    l2.observe(t4), l2.observe(s6), r5.srcdoc = function(e5) {
      let t5 = `<script>${Ft}<\/script>`, n4 = /<head(\s[^>]*)?>/i.exec(e5);
      if (n4) {
...
var Un = "'Cube', 'Sphere', 'Plane', 'Rectangle', 'Ellipse', 'Triangle', 'Polygon', 'Star', 'Cone', 'Cylinder', 'Pyramid', 'Torus', 'TorusKnot', 'Dodecahedron', 'Icosahedron', 'Helix', 'Backdrop', 'Lathe', 'Text', 'CustomMesh', 'Group', 'PointLight', 'SpotLight', 'DirectionalLight'";
var Gn = { cube: "CubeGeometry", box: "CubeGeometry", sphere: "SphereGeometry", plane: "PlaneGeometry", rectangle: "RectangleGeometry", ellipse: "EllipseGeometry", circle: "EllipseGeometry", triangle: "TriangleGeometry", polygon: "PolygonGeometry", star: "StarGeometry", cone: "ConeGeometry", cylinder: "CylinderGeometry", pyramid: "PyramidGeometry", torus: "TorusGeometry", torusknot: "TorusKnotGeometry", dodecahedron: "DodecahedronGeometry", icosahedron: "IcosahedronGeometry", helix: "HelixGeometry", backdrop: "BackdropGeometry", lathe: "LatheGeometry", text: "TextGeometry", custommesh: "NonParametricGeometry", nonparametric: "NonParametricGeometry" };
...
function Zn(e4, t4, n3) {
  ...
  if ("Mesh" === i2 && s6) {
    ...
    } else Object.assign(a2, Xr.defaultData, { geometry: "TextGeometry" === s6 ? Yn(r5) : Jn(s6, r5), material: qn(t4, n3) });
...
var li = class {
  constructor(e4, { renderOnDemand: t4, renderMode: n3 = "auto", wasmPath: i2, renderer: s6, htmlContentMode: r5 = "sandbox" } = {}) {
    ...
    this._renderedEvent = new CustomEvent("rendered", { bubbles: true }), Object.defineProperty(this._renderedEvent, "target", { writable: false, value: this }), window.location.search.includes("perfs") && import("./runtime-Perfs-KMJFDYHU-CVDYVZWJ.js").then(({ Perfs: e5 }) => {
  ...
  async _createRenderer() {
    ...
    if ("webgpu" === this._rendererBackend) try {
      let { createWebGPUSplineRenderer: e4, isWebGPUSupported: t4 } = await import("./runtime-webgpu-6PJLXU7X-5MNHBVKK.js");
      t4();
    ...
    {
      let { SplineRenderer: e4, rendererGlobals: t4 } = await import("./runtime-classicRuntime-PSJWHR3W-RQVTGFKP.js");
      try {
  ...
  async start(e4, { interactive: t4 = true, variables: n3 } = {}) {
    ...
    let r5 = await async function(e5) {
      let [t5, n4] = J(ct.deserialize(new Uint8Array(e5)));
      if (131 !== (t5.schema ?? 0)) {
        let { updateDocumentSchema: e6 } = await import("./runtime-updater-QYT2D73O-V33G5VEL.js");
        e6(t5);
      }
    ...
    r5.version && (0, Cn.default)(r5.version, "2.0.53") > 0 && console.warn("Your .splinecode file is more recent than the library. Please upgrade @splinetool/runtime to the latest version."), void 0 !== this._wasmPath && (this.setUIWasmUrl(`${this._wasmPath}/hana-ui.wasm`), r4(this._wasmPath));
    let l2 = async function(e5) {
      {
        let t5 = { particles: () => import("./runtime-particles-VNNGHRWB-WLDU7AOJ.js"), hair: () => import("./runtime-hair-2I5NL5AB-X3HLZQNY.js"), "shape-blends": () => import("./runtime-shapeBlends-RNRFZRZT-TOAKOMSU.js"), "vector-shapes": () => import("./runtime-vectorShapes-Y4HQJY6W-TMYMPT7O.js"), "3d-paths": () => import("./runtime-paths-JMJGABOE-T6PXZDBB.js"), cloners: () => import("./runtime-cloners-4ZDRWXX2-52FE4KEY.js"), components: () => import("./runtime-components-LS75QLT7-CMQKMQDR.js"), text: () => import("./runtime-text-53BT3JCR-MENC2KEM.js"), "ui-2d": () => import("./runtime-ui2d-L2MIZ4G2-N3FDHKQV.js"), "game-controls": () => import("./runtime-gameControls-BG6EZYET-ZB4BZHXE.js"), "collision-bvh": () => import("./runtime-collisionBVH-CQUE6RZV-DPXHD37P.js"), mousehover: () => import("./runtime-mouseHover-M5IWNDH7-E6RSME5M.js"), scroll: () => import("./runtime-scroll-IDJKADT2-TZFZYPS4.js"), dragdrop: () => import("./runtime-dragDrop-LIYELD7N-PSIDLAV4.js"), tracking: () => import("./runtime-tracking-KUQBXRKT-7A57KX2C.js"), resize: () => import("./runtime-resize-WI2WKGEB-C2VHFKN3.js"), conditional: () => import("./runtime-conditional-XSJDNYMV-6CVYEGMW.js"), variables: () => import("./runtime-variables-PI7YVOVR-NZ3BYNRG.js"), "api-services": () => import("./runtime-apiServices-TWKYVKXK-CKGW2BZ6.js"), "ai-assistant": () => import("./runtime-aiAssistant-Q7WOWTCF-TJRZMJQC.js"), textinputs: () => import("./runtime-textInputs-XZPFNNAY-D2ICALCD.js"), audio: () => import("./runtime-audio-EAVYJJ6Y-VEUTP5PM.js"), video: () => import("./runtime-video-5C4ZCNVD-CONJUPA3.js"), "create-destroy": () => import("./runtime-createDestroy-3DJAEURL-VAF2CD7K.js"), "scene-transition": () => import("./runtime-sceneTransition-ANVRIIG2-TIEAZCDB.js"), timeline: () => import("./runtime-timeline-WLUR7ICL-EBRYI73G.js"), transitions: () => import("./runtime-transitions-YTBVQWF3-LCIUQ5RF.js"), "misc-actions": () => import("./runtime-miscActions-OMOZBKVC-FLLBL65N.js") }, n4 = function(e6) {
          var _a2, _b2;
    ...
    await Promise.all([l2, o4.length && vn(this._wasmPath), w(r5) && zt(this._wasmPath), m(r5) && Wi(this._wasmPath), ua.physicsEnabled(r5.scene.objects) && lt(this._wasmPath), Ae(r5) && o2(), Gt(r5) && Zt(), r2(r5) && a(), e3(r5) && l2.then(() => {
      var _a2;
    ...
    if ("webgpu" === this._rendererBackend) try {
      await Promise.all([import("./runtime-webgpu-6PJLXU7X-5MNHBVKK.js"), (p3 = h3, Pn(p3, jn, "webgpu"))]), this._renderer || (this._renderer = await this._createRenderer());
    } catch (e5) {
      console.error("[spline] Failed to load the WebGPU material backend, using WebGL:", e5), this._rendererBackend = "webgl";
    }
    var p3;
    "webgpu" !== this._rendererBackend && await Promise.all([import("./runtime-classicRuntime-PSJWHR3W-RQVTGFKP.js"), Mn(h3)]), Yt2("webgpu" === this._rendererBackend ? "webgpu" : "webgl");
    let m3 = new fn(r5);
    if (m3.resetPersonalCameraFromDocumentData(), this._scene = m3.scene, this._sharedAssetsManager = m3.sharedAssets, this._camera = this._scene.activeCamera, window.location.search.includes("merge-geometries")) {
      let { mergeStaticGeometries: e5 } = await import("./runtime-mergeStaticGeometries-2UUVFTQ3-HANHGDBH.js"), t5 = performance.now();
      e5(r5, m3.scene);
    ...
    if (Promise.all(y2).then(() => {
      ...
      this._scene.traverseEntity((t5) => {
        (s2(t5) || t5 instanceof X) && t5.uiCanvas && e5.push(t5.uiCanvas);
    ...
    Gt(r5) && this._scene.initializeSplatViewer(), void 0 !== r5.scene.blueNoiseTextureData && this._renderer.pipeline.updateBlueNoiseTexture(r5.scene.blueNoiseTextureData);
  ...
  getAllObjects() {
    ...
    return (_a = this._scene) == null ? void 0 : _a.traverseEntity((t4) => {
      if (!(t4.uuid === Ot || this._scene.isInvisibleObjects(t4) || t4 instanceof X)) {
  ...
  _createProxyObject(e4) {
    ...
    let a2 = this._sharedAssetsManager, o4 = { shared: a2, scene: this._scene }, l2 = (t4) => {
    ...
    }, c2 = "material" in e4 ? e4.material : void 0, h3 = e4.materialOverride, d = { name: e4.name, uuid: e4.uuid, visible: e4.visible, intensity: e4.intensity, position: e4.position, rotation: e4.rotation, scale: e4.scale, type: e4.data.type, page: i2, material: h3 ?? (c2 ? ni(c2) : void 0), parentUuid: e4.parent instanceof X || e4 instanceof Ae2 ? void 0 : (_a = e4.parent) == null ? void 0 : _a.uuid, emitEvent(t4) {
      ...
      var _a2;
      let n3 = oi(t4);
      if (B.is(e4)) return void (e4.color = n3);
  ...
  async swapGeometry(e4, t4) {
    ...
    let i2 = ct.deserialize(n3), s6 = "data" in i2 && void 0 !== i2.data.draco;
  ...
  async createCustomMaterial(e4) {
    ...
    let t4 = ri();
    if (void 0 === t4 && ("webgpu" === this._rendererBackend && (await import("./runtime-webgpu-6PJLXU7X-5MNHBVKK.js"), t4 = ri()), void 0 === t4)) throw new Error("createCustomMaterial: requires the webgpu backend (the runtime default where WebGPU is available). This Application is on the classic WebGL pipeline — pass { renderer: 'webgpu' } or drop any ?renderer=webgl2 override.");
    let n3 = e4(t4);
  ...
  async createObject(e4, t4 = {}) {
    ...
    let s6 = function(e5) {
      if ("string" != typeof e5 || 0 === e5.length) throw new Error(`createObject: expected a type name string — one of ${Un}.`);
      ...
      let s7 = Nn[t5];
      throw s7 ? new Error(`createObject: '${e5}' is not supported — ${s7}`) : new Error(`createObject: '${e5}' is not a creatable Spline type — use one of ${Un}, e.g. createObject('Cube', { width: 200 }).`);
    }(e4);
    ...
    if ("TextGeometry" === s6.geometryType) {
      if (await import("./runtime-text-53BT3JCR-MENC2KEM.js"), !t2("text")) throw new Error("createObject: this runtime build was compiled without the 'text' feature — re-export the scene with a Text object present, or load the full runtime build.");
    ...
    let c2 = this._resolveParentId(t4.parent), h3 = Zn(s6, o4, i2), d = Zi.generateUUID(), [u2, p3] = J(i2);
  ...
  cloneObject(e4, t4 = {}) {
    ...
    if (r5 instanceof X) throw new Error("cloneObject: pages cannot be cloned.");
  ...
  removeObject(e4) {
    ...
    if (!s6) return false;
    if (s6 instanceof X) throw new Error("removeObject: pages cannot be removed.");
