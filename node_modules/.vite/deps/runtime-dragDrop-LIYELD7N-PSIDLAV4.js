...
// node_modules/@splinetool/runtime/build/runtime-dragDrop-LIYELD7N.js
var m = new Ki();
var g = new Ki();
var E = new Ki();
var f = new mn();
...
var w2 = function() {
  ...
  return (a2, i, r2) => {
    let o = a2.obj;
    t.copy(o.hiddenMatrix), null !== o.parent && t.premultiply(o.parent.matrixWorld), t.invert(), o.position.copy(i), "global" === a2.reference && T(o.position, a2.limits), o.position.applyMatrix4(t), "parent" === a2.reference ? T(o.position, a2.limits) : "local" === a2.reference && (x.copy(a2.quat0).invert(), o.position.sub(a2.position0), o.position.applyQuaternion(x), T(o.position, a2.limits), x.invert(), o.position.applyQuaternion(x), o.position.add(a2.position0)), t.multiply(r2 ?? o.matrixWorld).decompose(D, o.quaternion, y), o.updateMatrix(), o.hasNonUniformScale && (o.updateMatrixWorld(), o.updateMatrixWorldRigid()), o instanceof ie && j(o.parent) && o.invalidateDownstreamBooleanData(true);
  };
}();
var S = class {
...
var F = class extends s {
        ...
        if (r2.snapped = false, this.activeEvent.data.drop && (e4 = i.raycastWithClones(a3).filter((e5) => r2.obj !== e5.object && !r2.obj.isAncestorOf(e5.object.uuid) && !(e5.object instanceof r) && ("all" === this.activeEvent.data.dropOn || this.activeEvent.dropDestIds.some((t) => t === e5.object.uuid || i.scene.find(t).isAncestorOf(e5.object.uuid))))[0]), e4) {
          ...
          if ("center" === this.activeEvent.data.snapTo) r2.fromPosition.setFromMatrixPosition(e4.object.matrixWorld);
            ...
            if (r2.fromPosition.copy(e4.point), "bbox" === this.activeEvent.data.snapSurfaceMode) {
              ...
              let e5 = r2.obj;
              D.x > I ? y.x = -e5.recursiveBBox.min.x : D.x < -I && (y.x = -e5.recursiveBBox.max.x), D.y > I ? y.y = -e5.recursiveBBox.min.y : D.y < -I && (y.y = -e5.recursiveBBox.max.y), D.z > I ? y.z = -e5.recursiveBBox.min.z : D.z < -I && (y.z = -e5.recursiveBBox.max.z), y.applyMatrix3(j2.invert());
  ...
  updateDragItem(t, e2 = false) {
    var _a, _b;
    E.setFromMatrixPosition(t.obj.matrixWorld), "current" === t.reset ? m.subVectors(t.fromPosition, E).divideScalar(t.currentDampingFactor) : "original" === t.reset ? (m.subVectors(t.obj.userData.worldPosition0, E).divideScalar(t.currentDampingFactor), t.fromPosition.copy(t.obj.userData.worldPosition0), t.pointStart.copy(t.fromPosition), t.pointEnd.copy(t.pointStart)) : m.subVectors(t.pointEnd, t.pointStart).add(t.fromPosition).sub(E).divideScalar(t.currentDampingFactor), t.paused = !(t.currentDampingFactor > 1) || m.length() < 0.01, (this.activeEvent && 1 === this.activeEvent.data.dampingFactor || e2) && w2(t, m.add(E), ((_a = this.activeEvent) == null ? void 0 : _a.data.drop) && ((_b = this.activeEvent) == null ? void 0 : _b.data.autoOrient) ? t.orientationMatrix : null), t.obj.dispatchEvent({ type: "beginEvent", eventName: "DragDrop" }), this.eventManager.requestRender();
  }
...
//# sourceMappingURL=runtime-dragDrop-LIYELD7N-PSIDLAV4.js.map
