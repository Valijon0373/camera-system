...
// node_modules/@splinetool/runtime/build/runtime-chunk-4FY554U4.js
var C = new Ki();
var j = new $o();
...
var V = class extends l($o, w) {
  constructor(t = "", e = { ...Qr.defaultData, name: "" }) {
    super(), this._cameraType = "OrthographicCamera", this.targetOffset = st.DefaultTargetOffset, this.isUpVectorFlipped = false, this.angleOffsetFromUp = 0, this.wasMovedByUser = false, this.wasMovedBySwitchCameraAction = false, this._createdAt = typeof performance < "u" ? performance.now() : 0, this._tickProjectionTransition = () => {
      ...
      let e2 = V.projectionTransitionRequestRender ?? t2.requestRender;
  ...
  static withoutProjectionTransition(t) {
    let e = V.projectionTransitionsEnabled;
    V.projectionTransitionsEnabled = false;
    try {
      return t();
    } finally {
      V.projectionTransitionsEnabled = e;
    }
  }
  ...
  lookAt(t, e, r) {
    "number" == typeof t && (t = new Ki(t, e, r)), super.lookAt(t), this.getWorldPosition(x), this.targetOffset = x.distanceTo(t);
  }
  getTarget(t = new Ki()) {
    return this.getWorldDirection(b), this.getWorldPosition(x), b.multiplyScalar(this.targetOffset), t.copy(x).add(b), t;
  }
  getDistanceToTarget() {
    let t = this.getTarget();
    return this.getWorldPosition(x), x.distanceTo(t);
  }
  updateUp() {
  ...
  _canAnimateProjection() {
    return V.projectionTransitionsEnabled && "function" == typeof requestAnimationFrame && typeof performance < "u" && performance.now() - this._createdAt >= V.projectionTransitionMinAgeMs;
  }
  _beginProjectionTransition(t) {
    let e = this._projectionTransition;
    void 0 === e && (e = { from: new As(), blend: new As(), blendInverse: new As(), start: 0, duration: V.projectionTransitionDuration, referenceDepth: 1, raf: 0, requestRender: t }, this._projectionTransition = e), e.from.copy(this.projectionMatrix), e.start = performance.now(), e.duration = V.projectionTransitionDuration, e.referenceDepth = Number.isFinite(this.targetOffset) ? Math.max(1, this.targetOffset) : 1, t && (e.requestRender = t), 0 !== e.raf && cancelAnimationFrame(e.raf), e.raf = requestAnimationFrame(this._tickProjectionTransition);
  }
...
var A = V;
A.projectionTransitionsEnabled = false, A.projectionTransitionDuration = 350, A.projectionTransitionMinAgeMs = 1e3;

export {
  A
};
//# sourceMappingURL=chunk-ELF4IIHE.js.map
