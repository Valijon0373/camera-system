...
// node_modules/@splinetool/runtime/build/runtime-chunk-V2M6LVQI.js
var c;
var p3;
var f;
var x = b((t, e) => {
  ...
  !function(t2, e2) {
    ...
    var r, s = {}, n2 = { svg_path: xt2 }, a2 = xt2, h = function(t3) {
    ...
    }, c2 = /^[Zz]/, p4 = ut2(["Z", "z"], false, false), f2 = function() {
      return jt("Z");
    }, x2 = /^[Ll]/, g2 = ut2(["L", "l"], false, false), m2 = function(t3, e3) {
      return jt(t3, e3);
    }, y3 = /^[Hh]/, v2 = ut2(["H", "h"], false, false), w2 = function(t3, e3) {
      return jt(t3, e3.map(function(t4) {
        return { x: t4 };
      }));
    }, _2 = /^[Vv]/, S3 = ut2(["V", "v"], false, false), B2 = function(t3, e3) {
      return jt(t3, e3.map(function(t4) {
        return { y: t4 };
      }));
    }, b3 = /^[Cc]/, M2 = ut2(["C", "c"], false, false), C2 = function(t3, e3, i2) {
      return { x1: t3.x, y1: t3.y, x2: e3.x, y2: e3.y, x: i2.x, y: i2.y };
    }, k3 = /^[Ss]/, A2 = ut2(["S", "s"], false, false), T3 = function(t3, e3) {
      return { x2: t3.x, y2: t3.y, x: e3.x, y: e3.y };
    }, P2 = /^[Qq]/, z2 = ut2(["Q", "q"], false, false), R2 = function(t3, e3) {
      return { x1: t3.x, y1: t3.y, x: e3.x, y: e3.y };
    }, E2 = /^[Tt]/, O2 = ut2(["T", "t"], false, false), H2 = /^[Aa]/, F2 = ut2(["A", "a"], false, false), L2 = function(t3, e3, i2, r2, s2, n3) {
      ...
      return t3.join("");
    }, $2 = ".", G2 = dt2(".", false), Q2 = /^[eE]/, J2 = ut2(["e", "E"], false, false), K2 = /^[+\-]/, Z2 = ut2(["+", "-"], false, false), tt2 = /^[0-9]/, et2 = ut2([["0", "9"]], false, false), it2 = function(t3) {
      return t3.join("");
    ...
    function mt2() {
      var e3, i2;
      return c2.test(t2.charAt(nt2)) ? (i2 = t2.charAt(nt2), nt2++) : (i2 = s, 0 === lt2 && ft2(p4)), i2 !== s && (i2 = f2()), (e3 = i2) === s && (e3 = function() {
        var e4, i3, r2, n3;
        ...
        var e4, i3, r2, n3;
        if (e4 = nt2, y3.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(v2)), i3 !== s) {
          for (r2 = [], n3 = Ot(); n3 !== s; ) r2.push(n3), n3 = Ot();
        ...
        var e4, i3, r2, n3;
        if (e4 = nt2, _2.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(S3)), i3 !== s) {
          for (r2 = [], n3 = Ot(); n3 !== s; ) r2.push(n3), n3 = Ot();
        ...
        var e4, i3, r2, n3;
        if (e4 = nt2, b3.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(M2)), i3 !== s) {
          for (r2 = [], n3 = Ot(); n3 !== s; ) r2.push(n3), n3 = Ot();
          r2 !== s ? (n3 = function() {
        ...
        var e4, i3, r2, n3;
        if (e4 = nt2, k3.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(A2)), i3 !== s) {
          for (r2 = [], n3 = Ot(); n3 !== s; ) r2.push(n3), n3 = Ot();
          r2 !== s ? (n3 = function() {
            var t3, e5, i4, r3, n4, a3;
            if (t3 = nt2, (e5 = _t()) !== s) {
        ...
        var e4, i3, r2, n3;
        if (e4 = nt2, E2.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(O2)), i3 !== s) {
          for (r2 = [], n3 = Ot(); n3 !== s; ) r2.push(n3), n3 = Ot();
          r2 !== s ? (n3 = function() {
            var t3, e5, i4, r3, n4, a3;
            if (t3 = nt2, (e5 = bt()) !== s) {
        ...
        var e4, i3, r2, n3;
        if (e4 = nt2, H2.test(t2.charAt(nt2)) ? (i3 = t2.charAt(nt2), nt2++) : (i3 = s, 0 === lt2 && ft2(F2)), i3 !== s) {
          for (r2 = [], n3 = Ot(); n3 !== s; ) r2.push(n3), n3 = Ot();
          r2 !== s ? (n3 = function() {
            var t3, e5, i4, r3, n4, a3;
            if (t3 = nt2, (e5 = Bt()) !== s) {
    ...
    function Rt() {
      var e3;
      return K2.test(t2.charAt(nt2)) ? (e3 = t2.charAt(nt2), nt2++) : (e3 = s, 0 === lt2 && ft2(Z2)), e3;
    }
    function Et() {
      var e3, i2;
      if (e3 = [], tt2.test(t2.charAt(nt2)) ? (i2 = t2.charAt(nt2), nt2++) : (i2 = s, 0 === lt2 && ft2(et2)), i2 !== s) for (; i2 !== s; ) e3.push(i2), tt2.test(t2.charAt(nt2)) ? (i2 = t2.charAt(nt2), nt2++) : (i2 = s, 0 === lt2 && ft2(et2));
      else e3 = s;
      return e3 !== s && (e3 = it2(e3)), e3;
    }
    function Ot() {
      var e3;
      return rt2.test(t2.charAt(nt2)) ? (e3 = t2.charAt(nt2), nt2++) : (e3 = s, 0 === lt2 && ft2(st2)), e3 !== s && (e3 = V3()), e3;
    }
...
function v() {
  ...
  }(await import("./hana-ui-BXV4QMY6.js"), f ?? function() {
    let t = typeof process < "u" ? "2.0.53" : void 0;
...
((t) => {
  ...
  t.identity = function() {
    ...
    let [s, n2, a2, h, o, l] = e(i), [d, u, c2, p4, f2, x2] = e(r), g2 = d * s + u * a2, m2 = d * n2 + u * h, y3 = c2 * s + p4 * a2, v2 = c2 * n2 + p4 * h, w2 = f2 * s + x2 * a2 + o, _2 = f2 * n2 + x2 * h + l;
    return t.create(g2, m2, y3, v2, w2, _2);
  }, t.prepend = function(i, r) {
    let [s, n2, a2, h, o, l] = e(i), [d, u, c2, p4, f2, x2] = e(r), g2 = s, m2 = n2, y3 = a2, v2 = h;
    (1 !== d || 0 !== u || 0 !== c2 || 1 !== p4) && (g2 = s * d + n2 * c2, m2 = s * u + n2 * p4, y3 = a2 * d + h * c2, v2 = a2 * u + h * p4);
    let w2 = o * d + l * c2 + f2, _2 = o * u + l * p4 + x2;
    return t.create(g2, m2, y3, v2, w2, _2);
  }, t.getAbcdef = e, t.invert = function(e2) {
    let [i, r, s, n2, a2, h] = t.getAbcdef(e2), o = i * n2 - r * s, l = n2 / o, d = -r / o, u = -s / o, c2 = i / o, p4 = (s * h - n2 * a2) / o, f2 = -(i * h - r * a2) / o;
    return t.create(l, d, u, c2, p4, f2);
    ...
    let [r, s, n2, a2, h, o] = t.getAbcdef(e2), { rotation: l, scale: d, shear: u } = function(t2) {
      let e3 = t2[0][0], i2 = t2[1][0], r2 = t2[0][1], s2 = t2[1][1], n3 = Math.sqrt(e3 * e3 + i2 * i2), a3 = n3 > S2 ? e3 / n3 : 1, h2 = n3 > S2 ? i2 / n3 : 0, o2 = a3 * e3 + h2 * i2, l2 = a3 * s2 - h2 * r2, d2 = a3 * r2 + h2 * s2;
      return { rotation: Math.atan2(h2, a3), scale: [o2, l2], shear: [Math.abs(l2) > S2 ? d2 / l2 : 0, 0] };
    }([[r, n2], [s, a2]]);
    ...
    let [a2, h] = e2, [o, l] = s, [d, u, c2, p4] = function({ rotation: t2, scale: e3, shear: i2 }) {
    ...
    }({ rotation: r, scale: i, shear: n2 }), f2 = a2 - (o * d + l * c2) + o, x2 = h - (o * u + l * p4) + l;
    return t.create(d, u, c2, p4, f2, x2);
  };
})(_ || (_ = {}));
var b2;
var M;
...
var R = class {
  ...
  updateLocalMatrix() {
    this.localMatrix = _.compose(this.position, this.scale, this.rotation * w, S.getPivot(this.dataPatched), this.shear);
  }
  ...
  updateByOp(t, r, s) {
    ...
    this.updateByPatchedOpBase(n2, p2.patch(this.data, this.stateSelection ? this.data.states.data(this.stateSelection) : void 0), s);
  }
  changeSelectedState(t, e, r = false) {
    if (0 !== this.data.states.length || r) {
      for (let t2 of this.data.states) p2.toOps(this.data, t2.data).forEach((t3) => {
      ...
      if (null !== t) {
        ...
        r2 && (this.dataPatched = p2.patch(this.data, r2), p2.toOps(this.data, r2).forEach((t2) => {
...
var L = class extends R {
  ...
  updateByPatchedOp(t, i, r) {
    super.updateByPatchedOp(t, i, r), 0 === t.type && (V(t.path, ["fill"]) ? this.fill.update(t.props) : V(t.path, ["stroke"]) ? this.stroke.update(t.props) : V(t.path, ["dropShadow"]) ? this.dropShadow.update(t.props) : V(t.path, ["innerShadow"]) ? this.innerShadow.update(t.props) : V(t.path, ["layerBlur"]) ? this.layerBlur.update(t.props) : V(t.path, ["backgroundBlur"]) ? this.backgroundBlur.update(t.props) : this.resetBBoxNeedsUpdate());
  }
  updateState(t, e) {
...
((t) => {
  ...
  t.derive = function(t2) {
    ...
    return t2.derivative = n2, n2.derivative = M.derive(n2), n2;
  }, t.droot = function(i) {
...
var V2 = class extends D {
  constructor(t, e, i) {
    super(t, e, i), this.uuid = t, this.width = 0, this.height = 0, this.clipped = true, this.background = new N(t + "-background", y.defaultData, i), this.background.parent = this, this.updateState(e, i);
  }
  get fill() {
  ...
  clone(t) {
    let e = new V2(this.uuid, this.data, t);
    e.parent = void 0;
    for (let i of this.children) e.add(i.clone(t));
    return e;
  }
...
var K = class {
  constructor(t, e, i) {
    this.uuid = t, this.data = e, this.group = new W(K.GROUP_ID, { ...k.defaultData }, i), this.createChildrenObjects(e.objects, this.group, i);
  }
    ...
    let a2 = function(t2, e2, i2) {
      switch (e2.type) {
        ...
        case "path2d":
          return new $(t2, e2, i2);
        case "frame2d":
          return new V2(t2, e2, i2);
        default:
          return new W(t2, e2, i2);
      }
    }(t, e, n2);
    a2 && (r.add(a2), r.children.splice(s, 0, r.children.pop()), a2.updateWorldMatrix(), i.length > 0 && (a2 instanceof W || a2 instanceof V2) && this.createChildrenObjects(i, a2, n2));
  }
...
function et(t, e, i, r, s, n2, a2, h, o, l) {
  ...
  let d = n2 * Math.PI / 180, u = Math.cos(d), c2 = Math.sin(d), p4 = (e - o) / 2, f2 = (i - l) / 2, x2 = u * p4 + c2 * f2, g2 = -c2 * p4 + u * f2, m2 = x2 * x2 / (r * r) + g2 * g2 / (s * s);
  if (m2 > 1) {
    let t2 = Math.sqrt(m2);
    r *= t2, s *= t2;
  }
  let y3 = r * r, v2 = s * s, w2 = y3 * v2 - y3 * g2 * g2 - v2 * x2 * x2, _2 = y3 * g2 * g2 + v2 * x2 * x2, S3 = (a2 !== h ? 1 : -1) * Math.sqrt(Math.max(0, w2 / _2)), B2 = S3 * (r * g2) / s, b3 = S3 * (-s * x2) / r, M2 = u * B2 - c2 * b3 + (e + o) / 2, C2 = c2 * B2 + u * b3 + (i + l) / 2, k3 = Math.atan2((g2 - b3) / s, (x2 - B2) / r), A2 = Math.atan2((-g2 - b3) / s, (-x2 - B2) / r) - k3;
  !h && A2 > 0 ? A2 -= 2 * Math.PI : h && A2 < 0 && (A2 += 2 * Math.PI);
  let T3 = Math.max(1, Math.ceil(Math.abs(A2) / (Math.PI / 2))), P2 = A2 / T3, z2 = 4 / 3 * Math.tan(P2 / 4), R2 = k3, E2 = e, O2 = i;
  for (let e2 = 0; e2 < T3; e2++) {
    let e3 = R2 + P2, i2 = Math.cos(R2), n3 = Math.sin(R2), a3 = Math.cos(e3), h2 = Math.sin(e3), o2 = M2 + r * a3 * u - s * h2 * c2, l2 = C2 + r * a3 * c2 + s * h2 * u, d2 = -r * n3 * u - s * i2 * c2, p5 = -r * n3 * c2 + s * i2 * u, f3 = -r * h2 * u - s * a3 * c2, x3 = -r * h2 * c2 + s * a3 * u;
    t.push({ CurveTo: [{ x: E2 + z2 * d2, y: O2 + z2 * p5 }, { x: o2 - z2 * f3, y: l2 - z2 * x3 }, { x: o2, y: l2 }] }), R2 = e3, E2 = o2, O2 = l2;
  }
}
...
var ht = class {
  ...
  path(t) {
    this._startFreeform(), this._pathEls.push(...function(t2) {
      let e, i = [];
      try {
        e = (0, tt.makeAbsolute)((0, tt.parseSVG)(t2));
      } catch (t3) {
  ...
  _emitClippedRectStroke(t, e) {
    ...
    if ("skip" === u) return;
    let c2 = ft(u) ?? h, p4 = null;
    if (d) {
      let t2 = this._applyClips(pt(d, 0));
      p4 = "skip" === t2 ? null : ft(t2) ?? d;
    }
    let f2 = [];
    gt(f2, c2), p4 && function(t2, e2) {
  ...
  _applyClips(t, e = this._ctm) {
    ...
    for (let t2 of this._clips) {
      ...
      let c2 = s * u.minX + o, p4 = s * u.maxX + o, f2 = h * u.minY + l, x2 = h * u.maxY + l, g2 = Math.min(c2, p4), m2 = Math.max(c2, p4), y3 = Math.min(f2, x2), v2 = Math.max(f2, x2), w2 = t2.rect, S3 = Math.max(g2, w2.x), B2 = Math.max(y3, w2.y), b3 = Math.min(m2, w2.x + w2.w), M2 = Math.min(v2, w2.y + w2.h);
      if (S3 >= b3 || B2 >= M2) return "skip";
      if (S3 === g2 && B2 === y3 && b3 === m2 && M2 === v2) continue;
      let C2 = ft(i);
      if (!C2 || 0 === s || 0 === h) {
        at();
        continue;
      }
      let k3 = (S3 - o) / s, A2 = (b3 - o) / s, T3 = (B2 - l) / h, P2 = (M2 - l) / h, z2 = Math.min(k3, A2), R2 = Math.min(T3, P2), E2 = Math.abs(A2 - k3), O2 = Math.abs(P2 - T3), [H2, F2, L2, U2] = C2.radii, N2 = z2 !== C2.x, j2 = R2 !== C2.y, I2 = z2 + E2 !== C2.x + C2.w, D2 = R2 + O2 !== C2.y + C2.h, W2 = Math.min(E2, O2) / 2;
      i = pt({ x: z2, y: R2, w: E2, h: O2, radii: [N2 || j2 ? 0 : Math.min(H2, W2), I2 || j2 ? 0 : Math.min(F2, W2), I2 || D2 ? 0 : Math.min(L2, W2), N2 || D2 ? 0 : Math.min(U2, W2)] }, 0);
    }
    return i;
  }
  drawText(t, e) {
...
function mt({ constraints: t, newParentWidth: e, newParentHeight: i, initialParentWidth: r, initialParentHeight: s, objectInitialWidth: n2, objectInitialHeight: a2, objectInitialPosition: h }) {
  let { horizontalConstraint: o, verticalConstraint: l } = t, d = e - r, u = i - s, c2 = n2, p4 = a2, f2 = h[0], x2 = h[1];
  if (0 !== o) {
    if (1 === o) f2 += d;
    else if (3 === o) f2 += d / 2;
  ...
  if (0 !== l) {
    ...
    else if (2 === l) p4 = Math.max(1, p4 + u);
    else if (4 === l) {
      let t2 = i / s;
      p4 *= t2, x2 *= t2;
    }
  }
  return { width: c2, height: p4, position: [f2, x2] };
}
p(g(), 1);
...
//# sourceMappingURL=chunk-KXY35GIR.js.map
