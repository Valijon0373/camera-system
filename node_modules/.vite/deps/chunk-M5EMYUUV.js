...
// node_modules/@splinetool/runtime/build/runtime-chunk-YGGUUEFT.js
var W = Math.fround;
var Q = [0.01, 100];
var U = [0.01, 1e4];
var H = [0.01, 1e3];
...
function Y(e2, t, r3, a, n) {
  e2 = X(e2, Q), t = X(t, U), r3 = X(r3, H), a = X(a, J);
...
var $ = W(0.1);
function _(e2, t) {
  return W(W(1 - W(3 * t)) + W(3 * e2));
}
function ee(e2, t) {
  return W(W(3 * t) - W(6 * e2));
}
function te(e2) {
  return W(3 * e2);
}
function re(e2, t, r3) {
  return W(W(W(W(W(_(t, r3) * e2) + ee(t, r3)) * e2) + te(t)) * e2);
}
function ae(e2, t, r3) {
  let a = W(W(W(3 * _(t, r3)) * e2) * e2), n = W(W(2 * ee(t, r3)) * e2);
  return W(W(a + n) + te(t));
}
var ne = (e2) => e2;
function ie2(e2, t, r3, a) {
  if (e2 = W(e2), t = W(t), r3 = W(r3), a = W(a), e2 < 0 || e2 > 1 || r3 < 0 || r3 > 1 || e2 === t && r3 === a) return ne;
  let n = new Float32Array(11);
  for (let t2 = 0; t2 < 11; t2++) n[t2] = re(W(t2 * $), e2, r3);
  return (i3) => 0 === (i3 = W(i3)) || 1 === i3 ? i3 : re(((t2) => {
    let a2 = 0, i4 = 1;
    for (; 10 !== i4 && n[i4] <= t2; ) a2 = W(a2 + $), i4 += 1;
    i4 -= 1;
    let s = W(W(t2 - n[i4]) / W(n[i4 + 1] - n[i4])), o = W(a2 + W(s * $)), l = ae(o, e2, r3);
    return l >= Z ? function(e3, t3, r4, a3) {
      for (let n2 = 0; n2 < 4; n2++) {
        let n3 = ae(t3, r4, a3);
        if (0 === n3) return t3;
        let i5 = W(re(t3, r4, a3) - e3);
        t3 = W(t3 - W(i5 / n3));
      }
      return t3;
      ...
      let i5, s2 = 0, o2 = 0;
      do {
        s2 = W(t3 + W(W(r4 - t3) / 2)), i5 = W(re(s2, a3, n2) - e3), i5 > 0 ? r4 = s2 : t3 = s2, o2 += 1;
      } while (Math.abs(i5) > K && o2 < 10);
      return s2;
    }(t2, a2, W(a2 + $), e2, r3);
  })(i3), t, a);
}
...
function oe(e2, t, r3) {
  switch (e2.easing) {
    ...
    case 6: {
      ...
      return void 0 === a || void 0 === n || void 0 === i3 || void 0 === s ? r3 : W(Y(a, n, i3, s, t)(r3));
    }
  }
}
W(se + 1);
  ...
  constructor(e2, t, r3) {
    this.apply = t, this.onStart = r3, this.isPlaying = false, this.isReversed = false, this.endTime = 0, this.startTime = 0, this.isFirstLerpAfterStart = false, this.config = e2, this.duration = function(e3, t2) {
      ...
      return void 0 === r4 || void 0 === a || void 0 === n || void 0 === i3 ? t2 : function(e4, t3, r5, a2) {
        let n2 = 0.16666666666666666, i4 = 0, s = 0, o = Y(e4, t3, r5, a2);
...
function Be(a, n, d, c, p) {
  ...
  return a.data.visible && g.push(...function(e2, t, r3, a2, n2) {
    ...
    let l, u2, d2, c2, p2, h, f2, g2, m, b, y2, v, w, S, j2, V2 = [];
    ...
    if (a2 instanceof L || a2 instanceof V) {
      ...
      }(a2)), t.enabled || Object.assign(t, { enabled: true, radius: 0 }), r3.enabled || Object.assign(r3, { enabled: true, radius: 0 })), S = ge("radius", a2.backgroundBlur, t, r3, o), S && V2.push(S);
    }
    if (a2 instanceof L) {
    ...
    return n2;
  }(a, n, d, c.shared))) : B.is(a) ? a.data.visible && g.push(...function(e2, t, r3, a2) {
    let n2 = [];
    ...
    return n2;
  }(a, n, d, c.shared)) : a instanceof A && g.push(...function(e2, t, r3, a2) {
    var _a, _b, _c, _d;
...
var Ge = { type: "completeState", isfromEntity: false };
function Fe(e2, t) {
  var _a;
  let r3, a;
...
var Le = class {
  constructor(e2, t, r3, a, n, i3, s, o = {}, l = () => qe) {
    ...
    this.object = e2, this.fromRef = t, this.toRef = r3, this.data = a, this.sharedAssets = n, this.allowSlerp = i3, this.page = s, this.hooks = o, this.inert = l, this.builtReversed = false, this.startStateId = null, this.buildCallback = () => {
      this.builtReversed = this.runner.isReversed, this.startStateId = r2(this.object) ? null : this.object.transitionState.state, this.callback = Be(this.object, {}, function(e3, t2) {
    ...
    }, this.runner = new ue({ duration: (u2 = a).duration, ease: Pe(u2), ...Ne(u2) }, this.onChange, this.buildCallback), this.rebind();
  }
  rebind() {
  ...
  writeState(e2) {
    ...
    a.settled === t && a.state === r3 || (this.object.transitionState = { settled: t, state: r3 }, this.object.reversibleToState = this.end.id, this.object.prevState !== this.object.currentState && (this.object.prevState = this.object.currentState), this.object.currentState = r3, this.object.dispatchEvent({ type: "transitionState", settled: t, state: r3 }), this.object.dispatchEvent({ type: t ? "completeState" : "beginState", state: r3 }), this.object.traverseEntity((e3) => {
      e3 !== this.object && e3 instanceof A && e3.dispatchEvent(t ? Ge : Ie);
...
//# sourceMappingURL=chunk-M5EMYUUV.js.map
