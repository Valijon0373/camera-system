...
// node_modules/@splinetool/runtime/build/runtime-components-LS75QLT7.js
...
function b(e2, t, n, i2, r, a2, p, d, l2) {
  ...
  let c3 = 0;
  for (let f2 of r.children) if (mt.is(f2)) {
    let r2 = [...t, ..."string" == typeof f2.identity ? [f2.identity] : f2.identity], v = ea.resolve(n, r2, 1);
    null != v && !(v instanceof _) && (Object.setPrototypeOf(v, _.prototype), console.error("wrong prototype"));
    let g, I = null;
    if (!d) {
      let t2 = i2.children[c3];
      ...
      if (null === I && (I = e2.scene.findInstance(r2) ?? null, null !== I)) {
        ...
        if (g = t3 >= 1 ? I.stateSelection : void 0, 2 !== t3) I = null;
          ...
          I.parent.children.splice(t4, 1), i2.children.splice(c3, 0, I), I.parent === i2 ? t4 <= c3 && console.error("not possible") : (I.parent = i2, I.matrixWorldNeedsUpdate = true, I.resetBBoxNeedsUpdate(), I.updateVisible(), e2.pendingDeletes.delete(I));
        }
      }
    }
    if (null === I) {
      let t2 = v ? M.apply(f2.data, v) : f2.data;
      nt.is(t2.type) && (t2 = { ...t2, type: "Empty" }), I = C.createEntity(r2, t2, e2), I.overrideData = v, i2.add(I), i2.children.splice(i2.children.length - 1, 1), i2.children.splice(c3, 0, I), I.updateState(I.data, e2), g && I.changeSelectedState(g, e2), e2.scene.registerInstanceAndSetUuid(I);
    }
    I.isBone && (l2[I.identity[I.identity.length - 1]] = I.uuid), c3 += 1, b(e2, t, n, I, f2, a2, p + 1, d, l2);
  }
  if (!d) {
    let t2 = c3;
    for (; ; ) {
      let t3 = i2.children[c3];
      if (!mt.is(t3)) break;
      e2.pendingDeletes.add(t3), c3 += 1;
    }
    i2.children.splice(t2, c3 - t2);
  }
  return true;
}
var C2 = (e2, t, n) => new j(e2, t, n);
c("Component", C2), c("Instance", C2), a("components");
//# sourceMappingURL=runtime-components-LS75QLT7-CMQKMQDR.js.map
