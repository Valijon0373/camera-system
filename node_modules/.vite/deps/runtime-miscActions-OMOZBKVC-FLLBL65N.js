...
// node_modules/@splinetool/runtime/build/runtime-miscActions-OMOZBKVC.js
...
var I = class extends Fi {
  ...
  buildAnimation(a2 = false) {
    ...
    let r = { duration: this.data.duration, delay: 0, delayDirection: "start-once", direction: "normal", repeat: 0, ease: Pe(this.data) }, s = (t3) => {
...
n2("Link", ({ data: t3, eventManager: e2, shared: a2, actionCondition: i }) => new w(t3, e2.controlsManager, a2, i)), n2("Reset", ({ data: t3, page: e2, shared: a2, eventManager: i, actionCondition: r }) => new f(t3, e2, a2, i, r)), n2("SwitchCamera", ({ data: t3, page: e2, shared: a2, actionCondition: i }) => new I(t3, e2, a2, i)), n2("ClearLocalStorage", ({ data: t3, page: e2, shared: a2, actionCondition: i }) => new S(t3, e2, a2, i)), a("misc-actions");
//# sourceMappingURL=runtime-miscActions-OMOZBKVC-FLLBL65N.js.map
