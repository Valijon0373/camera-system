...
// node_modules/@splinetool/runtime/build/runtime-ui2d-L2MIZ4G2.js
function M(e2, t, i2, r) {
  return r ? i2 : 2048 / Math.max(1, e2, t);
}
var B = new ol(-1, 1, 1, -1, 0, 1);
var E = new class extends ha {
  constructor() {
    super(), this.setAttribute("position", new Hr([-1, 3, 0, -1, -1, 0, 3, -1, 0], 3)), this.setAttribute("uv", new Hr([0, 2, 0, 0, 2, 0], 2));
  }
}();
var U2 = new to({ defines: {}, uniforms: { tDiffuse: new Fl(null) }, vertexShader: "\n	varying vec2 vUv;\n	void main() {\n		vUv = uv;\n		gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );\n	}", fragmentShader: "\n	uniform sampler2D tDiffuse;\n	varying vec2 vUv;\n	void main() {\n		vec4 texel = texture2D( tDiffuse, vUv );\n		gl_FragColor = texel;\n	}" });
var z = new class {
  constructor(e2) {
    this._mesh = new Za(E, e2);
  }
  dispose() {
    this._mesh.geometry.dispose();
  }
  render(e2) {
    e2.render(this._mesh, B);
  }
  get material() {
...
var L = class {
  constructor(t, i2, r, s) {
    ...
    this.uuid = t, this.width = i2, this.height = r, this.context = s, this.enabled = true, this.isScreenSpace = false, this.dpr = window.devicePixelRatio, this.isFrameDirty = false, this.onRenderRequestedDownstream = () => {
      ...
      this.renderer.dpr = M(e2, t2, this.dpr, this.isScreenSpace), this.renderer.setSize(e2, t2);
    ...
    }, this.scene2d = new Z(Zi.generateUUID(), j.defaultData, { dpr: window.devicePixelRatio, shared: s.shared }), this.canvas = (null === k && (k = document.createElement("canvas")), k), this.renderer = (n = this.canvas, null === G && (G = new ht(n)), G), this.promise = this.init(), this.renderTarget = new Ms(1, 1, { type: Tt, stencilBuffer: false, depthBuffer: false }), s.shared.addUIBuffer(this.uuid, this.renderTarget), this.textureHolder = s.shared.uiBuffer(this.uuid);
  }
  get canvasTexture() {
  ...
  render(e2) {
    ...
    if (this.isFrameDirty) {
      if (this.isFrameDirty = false, this._innerApplySize(), this.renderer.clear(), (_a = this.frameOverride) == null ? void 0 : _a.draw(this.renderer), this.renderer.render(), this.canvasTexture.needsUpdate = true, e2.blitTextureToTarget) e2.blitTextureToTarget(this.canvasTexture, this.renderTarget);
        ...
        U2.uniforms.tDiffuse.value = this.canvasTexture;
  ...
  applyOverrides(e2) {
    if (this.frameOverride && this.frameRoot) {
      ...
      this.frameOverride.width = t, this.frameOverride.height = i2, this.frameOverride.localMatrix = C, this.isScreenSpace && (this.frameOverride.fill.color = wt.from0to1([0, 0, 0, 0])), this.frameOverride.data = { ...this.frameOverride.data, width: t, height: i2 }, _2({ objectOverride: this.frameOverride, objectRoot: this.frameRoot, newParentWidth: this.frameOverride.width, newParentHeight: this.frameOverride.height, initialParentWidth: this.frameRoot.width, initialParentHeight: this.frameRoot.height }), this.frameOverride.updateWorldMatrix(true, false, true);
    }
  }
  applySize(e2, t = window.devicePixelRatio) {
    ...
    let a2 = function(e3, t2, i3, r2) {
      let a3 = M(e3, t2, i3, r2), s = Math.max(i3, 512 / Math.min(e3, t2)), n = Math.min(s, a3);
  ...
  applyFrame(e2) {
    ...
    if (t && t instanceof V2) return this.disposeFrameOverride(), this.frameRoot = t, this.frameOverride = t.clone({ dpr: this.renderer.dpr, shared: this.context.shared }), this.scene2d.add(this.frameOverride), this.applySize(), (_a = this.frame) == null ? void 0 : _a.addEventListener("render", this.onRenderRequestedDownstream), this.frameOverride.traverse((e3) => {
...
function _2({ objectOverride: e2, objectRoot: t, newParentWidth: i2, newParentHeight: r, initialParentWidth: a2, initialParentHeight: s }) {
  if (e2 instanceof V2 && t instanceof V2 || e2 instanceof W && t instanceof W) for (let n = 0, h = e2.children.length; n < h; n++) {
    let h2 = e2.children[n], d = t.children[n];
    h2 && d && h2.uuid === d.uuid && V3({ objectOverride: h2, objectRoot: d, newParentWidth: i2, newParentHeight: r, initialParentWidth: a2, initialParentHeight: s });
  }
}
function V3({ objectOverride: e2, objectRoot: t, newParentWidth: i2, newParentHeight: r, initialParentWidth: a2, initialParentHeight: s }) {
  let [n, h] = function(e3) {
  ...
  if (A(e2) || e2 instanceof W) A(e2) && (e2.width = o, e2.height = u, e2.data = { ...e2.data, width: o, height: u }), _2({ objectOverride: e2, objectRoot: t, newParentWidth: o, newParentHeight: u, initialParentWidth: n, initialParentHeight: h });
...
function q({ stateId: e2, objectOverride: t, objectRoot: i2, newParentWidth: r, newParentHeight: a2, initialParentWidth: s, initialParentHeight: n }) {
  ...
  if (h && d) {
    let { width: i3, height: o, position: m } = mt({ constraints: t.data, newParentWidth: r, newParentHeight: a2, initialParentWidth: s, initialParentHeight: n, objectInitialWidth: S.isResizeable(d) ? d.width : 0, objectInitialHeight: S.isResizeable(d) ? d.height : 0, objectInitialPosition: d.position });
    Object.assign(t.states[e2], { position: m }), S.isResizeable(h) && Object.assign(t.states[e2], { width: i3, height: o });
  }
}
function A(e2) {
  return e2 instanceof N || e2 instanceof V2 || e2 instanceof U || e2 instanceof j2;
}
var N2 = class extends cr {
  constructor(e2, t, i2) {
    super(e2, t, i2), this.isUIObject = true, this.uiCanvas = new L(e2 + "-canvas", t.geometry.width, t.geometry.height, i2), this.uiCanvas.promise.then(() => {
  ...
  updateEntity2DByOp(e2, t, i2, r) {
    this.uiCanvas.updateEntity2DByOp(e2, t, i2, r), e2 === this.frameId && 0 === t.type && (void 0 !== t.props.cornerRadius ? this.applyGeometryParametersFromFrame(r) : V(t.path, ["backgroundBlur"]) && this.applyMaterialParametersFromFrame({ shared: r }));
  }
  get frame() {
...
i("UIGeometry", (e2, t, i2) => new N2(e2, t, i2)), p({ Scene2D: Z, UICanvas: L, loadHanaUIRUNTIME: v, setHanaUIWasmUrl: y }), a("ui-2d");
//# sourceMappingURL=runtime-ui2d-L2MIZ4G2-N3FDHKQV.js.map
