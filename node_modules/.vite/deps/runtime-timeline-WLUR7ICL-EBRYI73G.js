import {
  ...
  Re,
  oe
} from "./chunk-M5EMYUUV.js";
import "./chunk-KXY35GIR.js";
import "./chunk-734DUHPG.js";
import "./chunk-RSAA5MM2.js";
import {
  t
} from "./chunk-A4WWQFVE.js";
import "./chunk-T3FBTHTT.js";
import {
  p
...
// node_modules/@splinetool/runtime/build/runtime-timeline-WLUR7ICL.js
var _ = Math.fround;
function N(e) {
...
var U = class {
  ...
  layout(e) {
    let { config: t2 } = this;
    if (N(t2.direction) && e % 2 == 1) return { startDelay: 0, endDelay: 0 };
  ...
  cycleDuration(e) {
    ...
    return _(t2.duration + i2 + a2);
  }
  get totalDuration() {
    let { config: e } = this;
    if (-1 === e.repeat) return 1 / 0;
    let t2 = 0;
    for (let i2 = 0; i2 <= e.repeat; i2++) t2 = _(t2 + this.cycleDuration(i2));
    return t2;
  }
  isFinished(e) {
  ...
  resolve(e) {
    let t2, i2, { config: a2 } = this, n2 = _(e);
    if ("start-once" === a2.delayDirection) {
      let e2 = _(a2.delay + a2.duration);
      if (n2 < e2) t2 = 0, i2 = n2;
      else {
        let s2 = _(n2 - e2);
        t2 = 1 + Math.floor(_(s2 / a2.duration)), i2 = _(s2 % a2.duration);
      }
    } else if (N(a2.direction)) {
      let e2 = this.cycleDuration(0), s2 = _(e2 + a2.duration), r2 = Math.floor(_(n2 / s2)), o2 = _(n2 % s2);
      o2 < e2 ? (t2 = 2 * r2, i2 = o2) : (t2 = 2 * r2 + 1, i2 = _(o2 - e2));
    } else {
      let e2 = this.cycleDuration(0);
      t2 = Math.floor(_(n2 / e2)), i2 = _(n2 % e2);
    }
    if (-1 !== a2.repeat && t2 >= a2.repeat + 1) return null;
    let s, { startDelay: r } = this.layout(t2), o = N(a2.direction) && t2 % 2 == 1, l = r, h = _(l + a2.duration);
    if (i2 < l) s = o ? a2.duration : 0;
    else if (i2 >= h) s = o ? 0 : a2.duration;
    else {
      let e2 = _(i2 - l);
      s = o ? _(a2.duration - e2) : e2;
    }
...
function G(e, t2) {
  ...
  for (let a2 of e ?? []) {
    let e2 = t2(a2.data);
    void 0 !== e2 && i2.push({ time: a2.data.time, ease: L(a2.data.easing), value: e2 });
  }
  return { keyframes: B(i2) };
}
function P(t2, i2) {
  ...
  let { index0: a2, index1: n2, t: s } = function(t3, i3) {
    ...
    let h = V(l - o2), c = { ...t3[s2].ease, control2: t3[r2].ease.control2 };
    return { index0: s2, index1: r2, t: oe(c, h, V(V(i3 - o2) / h)) };
...
function W(e, s, r, l, u, p3, m) {
  ...
  switch (e.on) {
    ...
    case "scale": {
      let t2 = P(e.track, r);
      if (!t2) return;
      let i2 = R(t2.from, t2.to, t2.t);
      return s[e.on][e.axis] = i2, Q(p3, e.on, { [e.axis]: i2 }), void y();
    }
    case "rotation": {
      let t2 = P(e.track, r);
      if (!t2) return;
      let i2 = R(t2.from, t2.to, t2.t);
      return s.rotation[e.axis] = i2 * Zi.DEG2RAD, Q(p3, "rotation", { [e.axis]: i2 }), void y();
    }
    case "shapeSize": {
      let t2 = P(e.track, r);
      if (!(t2 && s instanceof cr)) return;
      let i2 = R(t2.from, t2.to, t2.t);
      return s.userData.value = { ...s.userData.value, [e.axis]: i2 }, Q(p3, "shapeSize", { [e.axis]: i2 }), m.size = true, m.bounds = true, m.boolean = true, void (m.render = true);
    }
    case "opacity": {
      let t2 = P(e.track, r);
    ...
    case "material": {
      ...
      for (let e2 in i2.data) {
        ...
        let r2 = K(t2.from[e2], t2.to[e2], t2.t, u);
      ...
      return Q(p3, "material", { [i2.uuid]: a2 }), void (m.render = true);
    }
    case "light": {
      let t2 = P(e.track, r);
      if (!t2 || !(s instanceof p2 || s instanceof p || s instanceof v)) return;
      let i2 = K(t2.from, t2.to, t2.t, u);
      return s[e.field] = i2, Q(p3, "light", { [e.field]: i2 }), void (m.render = true);
    }
    case "camera": {
      let t2 = P(e.track, r);
      if (!(t2 && s instanceof A)) return;
      let i2 = R(t2.from, t2.to, t2.t);
      return s[e.field] = i2, void Q(p3, "camera", { [e.field]: i2 });
    }
    case "cloner": {
      let t2 = P(e.track, r);
      if (!t2) return;
      let n2 = (_a = s.cloner) == null ? void 0 : _a.parameters, o = Oe(n2, t2.from, t2.to, t2.t);
      return Ce(n2, o), Q(p3, "cloner", o), m.cloner = true, m.boolean = true, void (m.render = true);
    }
    case "pathExtrusion": {
      let i2 = P(e.track, r);
      if (!i2 || !i(s)) return;
      let a2 = Ae(wr, i2.from, i2.to, i2.t), n2 = s.geometry.userData.parameters;
      return n2.extrusion = { ...n2.extrusion, ...a2 }, Q(p3, "pathExtrusion", a2), s.updateGeometryInteractions({ extrusion: { ...n2.extrusion } }, l.shared), m.bounds = true, m.boolean = true, void (m.render = true);
    }
    case "pathSnapping": {
      let i2 = P(e.track, r);
      if (!i2) return;
      let a2 = s, n2 = Ae(ja, i2.from, i2.to, i2.t);
      return a2.userData.pathSnapping = { ...a2.userData.pathSnapping, ...n2 }, Q(p3, "pathSnapping", n2), a2.updatePathSnapping(a2.userData.pathSnapping), void (m.render = true);
    }
  }
}
function K(e, t2, i2, a2) {
...
var Z = class extends Fi {
  constructor(e, t2, i2, a2, n2, s, r) {
    ...
    try {
      let e2 = ua.findTimeline(this.scene.data.objects, this.data.timeline), t3 = e2.duration;
        ...
        !r2 || this.evaluators.push(function(e3, t4, i3, a3, n4) {
          let s3 = function(e4, t5) {
            ...
            return Aa.groupKeyframes(t5.keyframes).forEach((t6) => {
              var _a;
              let a4 = (_a = t6.path) == null ? void 0 : _a[0], n5 = t6.path[1], s4 = () => G(t6.keyframes, (e5) => e5.value);
              switch (a4) {
                case "position":
                case "rotation":
                case "scale":
                ...
                case "path extrusion":
                  return void (i(e4) && i4.push({ on: "pathExtrusion", track: G(t6.keyframes, (e5) => e5.value) }));
                case "path snapping":
                  return void (e4.data.pathSnapping && i4.push({ on: "pathSnapping", track: G(t6.keyframes, (e5) => e5.value) }));
                case "material":
                  return void ("Mesh" === e4.type && "material" in e4 && function(e5, t7) {
                    ...
                    }, o = (e6) => "data" in e6 ? [{ on: "material", layer: e6, track: G(t7.keyframes, (e7) => e7.value) }] : [];
                    r3(a5);
                ...
                case "cloner":
                  return void i4.push({ on: "cloner", track: G(t6.keyframes, (e5) => e5.value) });
                case "camera":
                  return void (e4 instanceof A && i4.push({ on: "camera", field: "zoom", track: s4() }));
                case "light":
                  return void ((e4 instanceof p2 || e4 instanceof p || e4 instanceof v) && i4.push({ on: "light", field: t6.path[1], track: G(t6.keyframes, (e5) => e5.value) }));
              }
            }), i4;
          }(e3, t4);
          return { duration: i3, evaluate(t5, i4) {
            ...
            for (let o of s3) W(o, e3, t5, a3, n4, i4, r3);
            !function(e4, t6, i5) {
              var _a;
            ...
            for (let e4 of s3) z(e4.track);
          } };
        }(s2, { ...r2 }, t3, { scene: i2, shared: a2 }, this.sharedAssets));
      }), this.schedule = new U((l = this.data, { duration: t3, delay: _(l.delay / 1e3), delayDirection: l.delayDirection ?? "start-end", direction: l.direction ?? "normal", repeat: l.repeat }));
    } catch (e2) {
      throw new Error("Missing property");
    }
    var l;
    n2 && (J.has(n2.uuid) ? J.get(n2.uuid).push(this) : J.set(n2.uuid, [this])), H.set(e, this);
  }
  get playing() {
  ...
  finish() {
    this.pause(), this._finished = true, this.animatedObjectIds.forEach((e) => {
      ...
      t2 instanceof A && t2.dispatchEvent(Ge);
    });
  }
  startTicking() {
  ...
  play() {
    ...
    this.hasPlayedOnce = true, this.animatedObjectIds.forEach((e2) => {
      ...
      t2 instanceof A && t2.dispatchEvent(Ie);
...
var X = class {
  ...
  getTimelineActions(e) {
    let t2 = H.get(e);
    return t2 ? [t2] : [...H.values()].filter((t3) => t3.data.timeline === e);
  }
...
var Y = class {
  constructor(e, t2, i2, a2, n2, s, r) {
    ...
    if ("play" === o || void 0 === o) this.interaction = new Z(e, t2, i2, a2, n2, s, r);
    else {
      if ("pause" !== o && "stop" !== o) throw new Error("Missing property");
      this.interaction = new X(t2);
    }
  }
  get playing() {
    return this.interaction instanceof Z && this.interaction.playing;
  }
  get finished() {
    return !(this.interaction instanceof Z) || this.interaction.finished;
  }
  get paused() {
    return !(this.interaction instanceof Z) || this.interaction.paused;
  }
  play() {
    if (this.interaction instanceof Z) return this.interaction.play();
    this.interaction.dispatch();
  }
  stop() {
    this.interaction instanceof Z && this.interaction.stop();
  }
  seek(e) {
    this.interaction instanceof Z && this.interaction.seek(e);
  }
  toggle(e) {
    this.interaction instanceof Z ? this.interaction.toggle(e) : this.interaction.dispatch();
  }
  playFromCurrent() {
    this.interaction instanceof Z ? this.interaction.playFromCurrent() : this.interaction.dispatch();
  }
  dispatchConditional() {
    this.interaction instanceof Z ? C(this.interaction.sharedAssets, this.interaction.actionCondition) && this.interaction.playFromCurrent() : this.interaction.dispatch();
  }
  reverseFromCurrent() {
    this.interaction instanceof Z && this.interaction.reverseFromCurrent();
  }
  dispose() {
    this.interaction.dispose();
  }
};
n("TimelineAnimation", ({ id: e, data: t2, page: i2, shared: a2, object: n2, eventType: s, actionCondition: r }) => new Y(e, t2, i2.scene, a2, n2, s, r)), a("timeline");
//# sourceMappingURL=runtime-timeline-WLUR7ICL-EBRYI73G.js.map
