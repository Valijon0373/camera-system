...
// node_modules/@splinetool/runtime/build/runtime-textInputs-XZPFNNAY.js
...
var S = class {
  ...
  updatePlane() {
    var _a;
    let t2 = (_a = this.virtualInput) == null ? void 0 : _a.data;
    this.virtualInput && t2 && (L.getNormalMatrix(this.virtualInput.matrixWorld), T.copy(j).applyMatrix3(L).normalize(), this.virtualInput.localToWorld(D.set(0, 0, t2.geometry.depth)), this.plane.setFromNormalAndCoplanarPoint(T, D));
  }
...
var H = class extends s {
  constructor(t2, e2) {
    ...
    }, this.textInputManager = new S(this.sceneHelpers, t2.raycaster, t2.sharedAssets, t2.requestRender, this.onExit);
  }
  connect() {
    let t2 = [];
...
//# sourceMappingURL=runtime-textInputs-XZPFNNAY-D2ICALCD.js.map
