...
// node_modules/@splinetool/runtime/build/runtime-chunk-WW7RRGKX.js
var p = null;
function b(e) {
  p = e;
}
...
function k(e) {
  ...
  return m2 <= 0 ? null : { total: m2, sample: (t2, s2) => {
    ...
    let F2 = Math.sqrt(R2 * R2 + w2 * w2 + x2 * x2) || 1, B2 = 1, W2 = 1, k2 = 1;
    if (h) B2 = h.getX(c2) * v2 + h.getX(m3) * M2 + h.getX(f2) * y2, W2 = h.getY(c2) * v2 + h.getY(m3) * M2 + h.getY(f2) * y2, k2 = h.getZ(c2) * v2 + h.getZ(m3) * M2 + h.getZ(f2) * y2;
      ...
      a3 && (B2 = a3.r, W2 = a3.g, k2 = a3.b);
    }
    return { x: A2, y: j2, z: I2, nx: R2 / F2, ny: w2 / F2, nz: x2 / F2, cr: B2, cg: W2, cb: k2 };
  } };
}
function C(e) {
  ...
  }(e.seed ?? 1337), a = "object" === e.shape && e.sampler, i = a ? e.samplerRadius ?? B : B, r = new Float32Array(4 * F), n = new Float32Array(F), h = new Float32Array(4 * I).fill(1);
  for (let o = 0; o < t; o++) {
...
var q = class extends ie {
  ...
  applyScalpState() {
    ...
    this.scalpMesh.visible = !t, !t && (this.scalpMesh.geometry.dispose(), this.scalpMesh.geometry = "torus" === e ? new Xh(140, 70, 24, 48) : "cylinder" === e ? new Un(80, 80, 160, 48, 1) : new qh(B, 48, 32));
  }
  boneTransform(e, t) {
    var _a;
...
//# sourceMappingURL=chunk-VQSFEMY2.js.map
