...
// node_modules/@splinetool/runtime/build/runtime-chunk-DQ7IJ33I.js
var b = new As();
var A = new As();
var M = new As();
var S = new As();
...
function O(e, t, s3, o) {
  ...
  try {
    return 0 === i2 ? 0 : Qt(s3, D.subarray(0, 16 * i2));
  } finally {
    Zt(s3);
  }
}
        ...
        try {
          ...
          if (-1 === t.booleanMeshSetAddress) {
            if ((t.geometry.index ?? t.geometry.getAttribute("position")).count / 3 < 15e5) {
              ...
              t.booleanMeshSetAddress = void 0 === e2 || -1 === r2 ? r2 : O(t, e2, r2, b);
            }
...
//# sourceMappingURL=chunk-THOXRTWR.js.map
