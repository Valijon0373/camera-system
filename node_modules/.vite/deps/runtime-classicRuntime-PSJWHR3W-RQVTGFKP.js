...
import {
  t as t2
} from "./chunk-U7474U4J.js";
import {
  Ae as Ae2,
  xe as xe2
} from "./chunk-MXXREZQY.js";
import "./chunk-RUFHTFQT.js";
import "./chunk-RIILFETX.js";
import "./chunk-P4XWSAPW.js";
import "./chunk-LCKK7YFH.js";
import "./chunk-WV5OGPEO.js";
...
// node_modules/@splinetool/runtime/build/runtime-classicRuntime-PSJWHR3W.js
var Ui = class {
  constructor(e2) {
...
function Mo(e2, t3, n3, i3) {
  ...
  let x, S2, T2 = _2 + a4 + l2, b2 = _2 + r2 + c3, w2 = to2(o2, o2.VERTEX_SHADER, T2), E2 = to2(o2, o2.FRAGMENT_SHADER, b2);
  function M2(t4) {
    ...
    o2.deleteShader(w2), o2.deleteShader(E2), x = new eo2(o2, g2), S2 = function(e3, t5) {
...
function Po(e2, t3, n3, i3, a4, r2) {
  ...
  return { getParameters: function(a5, o3, c4, d3, m2, v2) {
    ...
    let E2, M2, y2, C2, R2 = _2.morphAttributes.position || _2.morphAttributes.normal || _2.morphAttributes.color, A3 = void 0 !== R2 ? R2.length : 0, P2 = 0;
...
function Bo(e2) {
  ...
  return { setup: function(a5) {
    ...
    for (let e3 = 0, x2 = a5.length; e3 < x2; e3++) {
      let x3 = a5[e3], S2 = x3.color, T2 = x3.intensity, b2 = x3.distance, w2 = null;
      if (x3.shadow && x3.shadow.map && (w2 = x3.shadow.map.texture.format === Dt ? x3.shadow.map.texture : x3.shadow.map.depthTexture || x3.shadow.map.texture), x3.isAmbientLight) r3 += S2.r * T2, o3 += S2.g * T2, s3 += S2.b * T2;
        ...
        let e4 = t3.get(x3);
        e4.position.setFromMatrixPosition(x3.matrixWorld), e4.color.copy(S2).multiplyScalar(T2), e4.distance = b2, e4.coneCos = Math.cos(x3.angle), e4.penumbraCos = Math.cos(x3.angle * (1 - x3.penumbra)), e4.decay = x3.decay, i3.spot[d2] = e4;
        let a6 = x3.shadow;
        ...
        let e4 = t3.get(x3);
        e4.color.copy(S2).multiplyScalar(T2), e4.halfWidth.set(0.5 * x3.width, 0, 0), e4.halfHeight.set(0, 0.5 * x3.height, 0), i3.rectArea[u3] = e4, u3++;
...
function $o(e2, t3, n3) {
  ...
  function S2(n4, a5, r3, o3, s4) {
    ...
    let l3 = n4.children;
    for (let e3 = 0, t4 = l3.length; e3 < t4; e3++) S2(l3[e3], a5, r3, o3, s4);
  }
  function T2(e3) {
  ...
  this.render = function(t4, n4, s4) {
    ...
    for (let l4 = 0, c5 = t4.length; l4 < c5; l4++) {
      ...
      for (let t5 = 0; t5 < v3; t5++) {
        ...
        i3 = u5.getFrustum(), S2(n4, s4, u5.camera, c6, this.type);
      }
...
function qo(e2, t3) {
  ...
  }(), r2 = /* @__PURE__ */ new WeakMap(), o2 = /* @__PURE__ */ new WeakMap(), s3 = {}, l2 = {}, c3 = {}, d2 = /* @__PURE__ */ new WeakMap(), u3 = [], f3 = null, p2 = false, h3 = null, m2 = null, v2 = null, g2 = null, _2 = null, x = null, S2 = null, T2 = new rr(0, 0, 0), b2 = 0, w2 = false, E2 = null, M2 = null, y2 = null, C2 = null, R2 = null, A3 = e2.getParameter(e2.MAX_COMBINED_TEXTURE_IMAGE_UNITS), P2 = false, D2 = 0, L3 = e2.getParameter(e2.VERSION);
  ...
  function X2(t4, n4, i4, a5, r3, o3, s4, l3, c4, d3) {
    if (t4 !== p) {
      if (false === p2 && (H3(e2.BLEND), p2 = true), t4 === g) r3 = r3 || n4, o3 = o3 || i4, s4 = s4 || a5, (n4 !== m2 || r3 !== _2) && (e2.blendEquationSeparate(k2[n4], k2[r3]), m2 = n4, _2 = r3), (i4 !== v2 || a5 !== g2 || o3 !== x || s4 !== S2) && (e2.blendFuncSeparate(W2[i4], W2[a5], W2[o3], W2[s4]), v2 = i4, g2 = a5, x = o3, S2 = s4), (false === l3.equals(T2) || c4 !== b2) && (e2.blendColor(l3.r, l3.g, l3.b, c4), T2.copy(l3), b2 = c4), h3 = t4, w2 = false;
      else if (t4 !== h3 || d3 !== w2) {
        ...
        v2 = null, g2 = null, x = null, S2 = null, T2.set(0, 0, 0), b2 = 0, h3 = t4, w2 = d3;
      }
  ...
  return { buffers: { color: n3, depth: i3, stencil: a4 }, enable: H3, disable: G2, bindFramebuffer: function(t4, n4) {
    ...
    void 0 === t4 && (t4 = e2.TEXTURE0 + A3 - 1), U2 !== t4 && (e2.activeTexture(t4), U2 = t4);
  }, bindTexture: function(t4, n4, i4) {
    void 0 === i4 && (i4 = null === U2 ? e2.TEXTURE0 + A3 - 1 : U2);
    let a5 = N2[i4];
...
function Yo(e2, t3, n3, i3, a4, r2, o2) {
  ...
  function S2(n4, i4, a5, r3, o3, s4 = false) {
    if (null !== n4) {
  ...
  let R2 = { [ut]: e2.REPEAT, [ct]: e2.CLAMP_TO_EDGE, [pt]: e2.MIRRORED_REPEAT }, A3 = { [dt]: e2.NEAREST, [mt]: e2.NEAREST_MIPMAP_NEAREST, [yt]: e2.NEAREST_MIPMAP_LINEAR, [ft]: e2.LINEAR, [gt]: e2.LINEAR_MIPMAP_NEAREST, [xt]: e2.LINEAR_MIPMAP_LINEAR }, P2 = { [li]: e2.NEVER, [fi]: e2.ALWAYS, [ui]: e2.LESS, [pi]: e2.LEQUAL, [ci]: e2.EQUAL, [yi]: e2.GEQUAL, [di]: e2.GREATER, [mi]: e2.NOTEQUAL };
  function D2(n4, r3) {
    if (r3.type === zt && false === t3.has("OES_texture_float_linear") && (r3.magFilter === ft || r3.magFilter === gt || r3.magFilter === yt || r3.magFilter === xt || r3.minFilter === ft || r3.minFilter === gt || r3.minFilter === yt || r3.minFilter === xt) && Oi("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), e2.texParameteri(n4, e2.TEXTURE_WRAP_S, R2[r3.wrapS]), e2.texParameteri(n4, e2.TEXTURE_WRAP_T, R2[r3.wrapT]), (n4 === e2.TEXTURE_3D || n4 === e2.TEXTURE_2D_ARRAY) && e2.texParameteri(n4, e2.TEXTURE_WRAP_R, R2[r3.wrapR]), e2.texParameteri(n4, e2.TEXTURE_MAG_FILTER, A3[r3.magFilter]), e2.texParameteri(n4, e2.TEXTURE_MIN_FILTER, A3[r3.minFilter]), r3.compareFunction && (e2.texParameteri(n4, e2.TEXTURE_COMPARE_MODE, e2.COMPARE_REF_TO_TEXTURE), e2.texParameteri(n4, e2.TEXTURE_COMPARE_FUNC, P2[r3.compareFunction])), true === t3.has("EXT_texture_filter_anisotropic")) {
  ...
  function N2(t4, o3, s4) {
    ...
    if (d3.version !== u4.__version || true === c4) {
      ...
      t5 = k2(o3, t5);
      let i4 = r2.convert(o3.format, o3.colorSpace), p3 = r2.convert(o3.type), h4 = S2(o3.internalFormat, i4, p3, o3.normalized, o3.colorSpace, o3.isVideoTexture);
      D2(l3, o3);
  ...
  function I3(t4, a5, o3, s4, c4, d3) {
    let u4 = r2.convert(o3.format, o3.colorSpace), f4 = r2.convert(o3.type), p3 = S2(o3.internalFormat, u4, f4, o3.normalized, o3.colorSpace), h4 = i3.get(a5), m3 = i3.get(o3);
  ...
  function O2(t4, n4, i4) {
    if (e2.bindRenderbuffer(e2.RENDERBUFFER, t4), n4.depthBuffer) {
      ...
      for (let a5 = 0; a5 < t5.length; a5++) {
        let o3 = t5[a5], s4 = r2.convert(o3.format, o3.colorSpace), c4 = r2.convert(o3.type), d3 = S2(o3.internalFormat, s4, c4, o3.normalized, o3.colorSpace);
  ...
  this.allocateTextureUnit = function() {
    ...
    true !== t4.isCubeDepthTexture && t4.version > 0 && s4.__version !== t4.version ? function(t5, o4, s5) {
      ...
      if (c4.version !== d3.__version || true === l3) {
        ...
        let m3, x2 = h4[0], T3 = r2.convert(o4.format, o4.colorSpace), w3 = r2.convert(o4.type), E3 = S2(o4.internalFormat, T3, w3, o4.normalized, o4.colorSpace), M3 = true !== o4.isVideoTexture, y3 = void 0 === d3.__version || true === l3, C3 = c4.dataReady, R3 = b2(o4, x2);
    ...
    if (u4 || (void 0 === l3.__webglTexture && (l3.__webglTexture = e2.createTexture()), l3.__version = a5.version, o2.memory.textures++), d3) {
      ...
      if (t4.samples > 0 && false === G2(t4)) {
        ...
        for (let n4 = 0; n4 < c4.length; n4++) {
          ...
          let a6 = r2.convert(i4.format, i4.colorSpace), o3 = r2.convert(i4.type), l4 = S2(i4.internalFormat, a6, o3, i4.normalized, i4.colorSpace, true === t4.isXRRenderTarget), d4 = H3(t4);
...
var ns = class {
  constructor(e2 = {}) {
    ...
    let h3 = p2, m2 = /* @__PURE__ */ new Set([jt, Wt, Lt]), v2 = /* @__PURE__ */ new Set([bt, At, St, kt, Ct, It]), g2 = new Uint32Array(4), _2 = new Int32Array(4), x = new Ki(), S2 = null, T2 = null, b2 = [], w2 = [], E2 = null;
    ...
    let M2 = this, y2 = false, C2 = null, R2 = null, A3 = null, P2 = null;
    ...
    function Fe2() {
      ae2 = new Ga(Ne), ae2.init(), Pe = new Ko(Ne, ae2), re2 = new za(Ne, ae2, e2, Pe), oe3 = new qo(Ne, ae2), re2.reversedDepthBuffer && f3 && oe3.buffers.depth.setReversed(true), R2 = Ne.createFramebuffer(), A3 = Ne.createFramebuffer(), P2 = Ne.createFramebuffer(), se3 = new Xa(Ne), de3 = new Do(), fe2 = new Yo(Ne, ae2, oe3, de3, re2, Pe, se3), pe2 = new Ha(M2), he2 = new Ra(Ne), De2 = new Oa(Ne, he2), ve2 = new ka(Ne, he2, se3, De2), ge2 = new $a(Ne, ve2, he2, De2, se3), Ce = new ja(Ne, re2, fe2), we2 = new Ba(de3), _e2 = new Po(M2, pe2, ae2, re2, De2, we2), Se2 = new Qo(M2, de3), Te = new Io(), be2 = new Ho(ae2), ye2 = new Ia(M2, pe2, oe3, ge2, t3, l2), Me2 = new $o(M2, ge2, re2), Ue2 = { update() {
    ...
    this.xr = ze, this.getContext = function() {
      ...
      let o3 = a5.isMesh && a5.matrixWorld.determinantAffine() < 0, s4 = function(e4, t5, n5, i5, a6) {
        ...
        if (E3 || I3 !== e4) {
          oe3.buffers.depth.getReversed() && true !== e4.reversedDepth && (e4._reversedDepth = true, e4.updateProjectionMatrix()), A4.setValue(Ne, "projectionMatrix", e4.projectionMatrix), A4.setValue(Ne, "viewMatrix", e4.matrixWorldInverse);
          let t6 = A4.map.cameraPosition;
          void 0 !== t6 && t6.setValue(Ne, Q2.setFromMatrixPosition(e4.matrixWorld)), re2.logarithmicDepthBuffer && A4.setValue(Ne, "logDepthBufFC", 2 / (Math.log(e4.far + 1) / Math.LN2)), (i5.isMeshPhongMaterial || i5.isMeshToonMaterial || i5.isMeshLambertMaterial || i5.isMeshBasicMaterial || i5.isMeshStandardMaterial || i5.isShaderMaterial) && A4.setValue(Ne, "isOrthographic", true === e4.isOrthographicCamera), I3 !== e4 && (I3 = e4, y3 = true, R3 = true);
        }
        if (_3.needsLights && (S3.state.directionalShadowMap.length > 0 && A4.setValue(Ne, "directionalShadowMap", S3.state.directionalShadowMap, fe2), S3.state.spotShadowMap.length > 0 && A4.setValue(Ne, "spotShadowMap", S3.state.spotShadowMap, fe2), S3.state.pointShadowMap.length > 0 && A4.setValue(Ne, "pointShadowMap", S3.state.pointShadowMap, fe2)), a6.isSkinnedMesh) {
          A4.setOptional(Ne, a6, "bindMatrix"), A4.setOptional(Ne, a6, "bindMatrixInverse");
          let e5 = a6.skeleton;
          e5 && (null === e5.boneTexture && e5.computeBoneTexture(), A4.setValue(Ne, "boneTexture", e5.boneTexture, fe2));
        }
        a6.isBatchedMesh && (A4.setOptional(Ne, a6, "batchingTexture"), A4.setValue(Ne, "batchingTexture", a6._matricesTexture, fe2), A4.setOptional(Ne, a6, "batchingIdTexture"), A4.setValue(Ne, "batchingIdTexture", a6._indirectTexture, fe2), A4.setOptional(Ne, a6, "batchingColorTexture"), null !== a6._colorsTexture && A4.setValue(Ne, "batchingColorTexture", a6._colorsTexture, fe2));
        let D3 = n5.morphAttributes;
        if ((void 0 !== D3.position || void 0 !== D3.normal || void 0 !== D3.color) && Ce.update(a6, n5, w3), (y3 || _3.receiveShadow !== a6.receiveShadow) && (_3.receiveShadow = a6.receiveShadow, A4.setValue(Ne, "receiveShadow", a6.receiveShadow)), (i5.isMeshStandardMaterial || i5.isMeshLambertMaterial || i5.isMeshPhongMaterial) && null === i5.envMap && null !== t5.environment && (P3.envMapIntensity.value = t5.environmentIntensity), void 0 !== P3.dfgLUT && (P3.dfgLUT.value = (null === ts && ((ts = new Qa(es, 16, 16, Dt, Tt)).name = "DFG_LUT", ts.minFilter = ft, ts.magFilter = ft, ts.wrapS = ct, ts.wrapT = ct, ts.generateMipmaps = false, ts.needsUpdate = true), ts)), y3) {
          if (A4.setValue(Ne, "toneMappingExposure", M2.toneMappingExposure), _3.needsLights && function(e5, t6) {
        ...
        if (i5.isShaderMaterial && true === i5.uniformsNeedUpdate && (eo2.upload(Ne, rt(_3), P3, fe2), i5.uniformsNeedUpdate = false), i5.isSpriteMaterial && A4.setValue(Ne, "center", a6.center), A4.setValue(Ne, "modelViewMatrix", a6.modelViewMatrix), A4.setValue(Ne, "normalMatrix", a6.normalMatrix), A4.setValue(Ne, "modelMatrix", a6.matrixWorld), a6.previousModelViewMatrix && A4.setValue(Ne, "previousModelViewMatrix", a6.previousModelViewMatrix), e4.previousProjectionMatrix && A4.setValue(Ne, "previousProjectionMatrix", e4.previousProjectionMatrix), void 0 !== i5.uniformsGroups) {
      ...
      if (e3.layers.test(t4.layers)) {
        if (e3.isGroup) n4 = e3.renderOrder;
          ...
          if (!e3.frustumCulled || Y3.intersectsSprite(e3)) {
            ...
            a6.visible && S2.push(e3, t5, a6, n4, ee2.z, null);
          }
          ...
          if (i4 && (void 0 !== e3.boundingSphere ? (null === e3.boundingSphere && e3.computeBoundingSphere(), ee2.copy(e3.boundingSphere.center)) : (null === t5.boundingSphere && t5.computeBoundingSphere(), ee2.copy(t5.boundingSphere.center)), ee2.applyMatrix4(e3.matrixWorld).applyMatrix4(J2)), Array.isArray(a6)) {
            ...
            for (let r3 = 0, o3 = i5.length; r3 < o3; r3++) {
              ...
              s4 && s4.visible && S2.push(e3, t5, s4, n4, ee2.z, o4);
            }
          } else a6.visible && S2.push(e3, t5, a6, n4, ee2.z, null);
        }
      }
      let a5 = e3.children;
    ...
    Ye.setAnimationLoop(function(e3) {
      ...
      let x2 = oe3.getParameter(Ne.UNPACK_ROW_LENGTH), S3 = oe3.getParameter(Ne.UNPACK_IMAGE_HEIGHT), T3 = oe3.getParameter(Ne.UNPACK_SKIP_PIXELS), b3 = oe3.getParameter(Ne.UNPACK_SKIP_ROWS), w3 = oe3.getParameter(Ne.UNPACK_SKIP_IMAGES);
      ...
      if (e3.isDepthTexture) {
        ...
        oe3.bindFramebuffer(Ne.READ_FRAMEBUFFER, A3), oe3.bindFramebuffer(Ne.DRAW_FRAMEBUFFER, P2);
      ...
      oe3.pixelStorei(Ne.UNPACK_ROW_LENGTH, x2), oe3.pixelStorei(Ne.UNPACK_IMAGE_HEIGHT, S3), oe3.pixelStorei(Ne.UNPACK_SKIP_PIXELS, T3), oe3.pixelStorei(Ne.UNPACK_SKIP_ROWS, b3), oe3.pixelStorei(Ne.UNPACK_SKIP_IMAGES, w3), 0 === r3 && t4.generateMipmaps && Ne.generateMipmap(v3), oe3.unbindTexture();
...
var Vs3 = class extends Bi {
  ...
  generate(e2, t3) {
    if (e2.require("worldNormal"), e2.require("worldPosition"), e2.isShader("fragment")) {
      ...
      let n3 = e2.include(Vs3.Nodes.toon), i3 = [];
...
var js = Xs;
js.Nodes = { vertexColorLayer: new $i("vec3 vertexColorLayer(vec4 vcolor, float mask, float alpha, out float calpha) {\n				float lalpha = alpha * mask * vcolor.a;\n				calpha =  lalpha / clamp(lalpha + accumAlpha, 0.00001, 1.0);\n				accumAlpha += (1.0 - accumAlpha) * lalpha;\n\n				return vcolor.rgb;\n			}") };
var $s;
...
function dl(e2, t3, n3) {
  ...
  let i3 = Fs[e2.type], a4 = Vs2[e2.type];
  if (void 0 !== a4) {
    let i4 = e2.color;
    if (a4.includes(t3)) {
...
i2({ createMaterial: (e2, t3) => new Vl(e2, t3), createComputation: (e2, t3, n3) => new Wl(e2, t3, n3) }), ll("texture", Xl), ll("video", Xl), ll("matcap", (e2, t3, n3, i3) => {
  ...
  let r2 = h2(n3, i3), o2 = new Wi(Ts(r2.scale, i3) ?? 1), s3 = new Gi2(pl(r2.size ?? new Ki(100, 100, 100), i3)), l2 = new Wi(Ts(r2.move, i3) ?? 1), c3 = new Hi(hl(r2.fA ?? new Gi(1.7, 9.2), i3)), d2 = new Hi(hl(r2.fB ?? new Gi(8.3, 2.8), i3)), u3 = new Hi(hl(r2.distortion ?? new Gi(1, 1), i3)), f3 = new ki2(r2.colorA), p2 = new ki2(r2.colorB), h3 = new ki2(r2.colorC), m2 = new ki2(r2.colorD), v2 = new ya(r2.noiseType ?? 0), _2 = new ya(r2.voronoiStyle ?? 0), x = new Wi(Ts(r2.highCut, i3) ?? 1), S2 = new Wi(Ts(r2.lowCut, i3) ?? 0), T2 = new Wi(Ts(r2.smoothness, i3) ?? 0.5), b2 = new Wi(Ts(r2.seed, i3) ?? 0.5), w2 = new ya(r2.quality ?? 1), E2 = Sl(r2), M2 = new Us(o2, s3, l2, c3, d2, u3, f3, p2, h3, m2, E2.alpha, v2, E2.isMask, _2, x, S2, T2, b2, w2), y2 = new ia(M2.calpha, "f");
  return new gl(e2, t3, n3, { scale: o2, size: s3, move: l2, fA: c3, fB: d2, distortion: u3, colorA: f3, colorB: p2, colorC: h3, colorD: m2, noiseType: v2, ...E2, voronoiStyle: _2, highCut: x, lowCut: S2, smoothness: T2, seed: b2, quality: w2 }, M2, E2.mode, y2, E2.isMask, i3);
}), ll("rainbow", (e2, t3, n3, i3, r2) => {
  let o2 = h2(n3, i3), s3 = new Wi(Ts(o2.filmThickness, i3) ?? 30), l2 = new Wi(Ts(o2.movement, i3) ?? 0), c3 = new Gi2(pl(o2.wavelengths, i3)), d2 = new Wi(Ts(o2.noiseStrength, i3) ?? 0), u3 = new Wi(Ts(o2.noiseScale, i3) ?? 1), f3 = new Gi2(pl(o2.offset, i3)), p2 = Sl(o2), h3 = true === (r2 == null ? void 0 : r2.forceRainbowNoise), m2 = h3 || ks(o2.noiseStrength), v2 = new Bs(s3, l2, c3, d2, u3, f3, p2.alpha, p2.isMask, m2), _2 = new ia(v2.calpha, "f"), S2 = new gl(e2, t3, n3, { filmThickness: s3, movement: l2, wavelengths: c3, noiseStrength: d2, noiseScale: u3, offset: f3, ...p2 }, v2, p2.mode, _2, p2.isMask, i3);
  return S2.noiseCompiledIn = m2, S2.noiseForced = h3, S2;
}), ll("toon", (e2, t3, n3, i3) => {
...
ll("reflection", (e2, t3, n3, i3) => {
  ...
  let r2 = h2(n3, i3), o2 = new ya(r2.style ?? 0), s3 = new ya(r2.projection ?? 0), l2 = new ya(["x", "y", "z"].indexOf(r2.axis) ?? 0), c3 = new Wi(Ts(r2.blending ?? 0, i3)), d2 = new Hi(hl(r2.offset, i3)), u3 = new ki2(r2.colorA), f3 = new ki2(r2.colorB), p2 = new Hi(hl(r2.frequency ?? new Gi(10, 10), i3)), h3 = new Wi(Ts(r2.size ?? 0.5, i3)), m2 = new Wi(Ts(r2.variation ?? 0, i3)), v2 = new Wi(Ts(r2.smoothness ?? 0.5, i3)), _2 = new Wi(Ts(r2.zigzag ?? 0, i3)), x = new Wi(Ts(r2.rotation ?? 0, i3)), S2 = new Hi(hl(r2.vertical ?? new Gi(0, 1), i3)), T2 = new Hi(hl(r2.horizontal ?? new Gi(0, 1), i3)), b2 = new ya(r2.sides ?? 6), w2 = Sl(r2), E2 = new Fs2(o2, s3, l2, c3, d2, u3, f3, p2, h3, m2, v2, _2, x, S2, T2, b2, w2.alpha, w2.isMask), M2 = new ia(E2.calpha, "f");
  return new gl(e2, t3, n3, { style: o2, projection: s3, axis: l2, blending: c3, offset: d2, colorA: u3, colorB: f3, frequency: p2, size: h3, variation: m2, smoothness: v2, zigzag: _2, rotation: x, vertical: S2, horizontal: T2, sides: b2, ...w2 }, E2, w2.mode, M2, w2.isMask, i3);
}), ll("vertexColor", (e2, t3, n3, i3) => {
  let r2 = Sl(h2(n3, i3)), o2 = new js(r2.alpha), s3 = new ia(o2.calpha, "f");
...
var Ec = class extends Fi {
  constructor(e2, t3) {
    super(), this._needsDOFResize = t3, this.postprocessingState = Pr.defaultData, this._scene = new hr(), this._camera = new A2(), this.effects = /* @__PURE__ */ new Map(), this.blueNoiseTexture = new Qa(), this._renderToScreen = true, this._isUIOverlayEnabled = false, this.timer = new bl(), this.renderer = e2, this.debug = false;
...
var Cc = class extends ns {
  constructor(t3) {
    super(t3), this._pixelRatio = this.getPixelRatio(), this.viewportWidth = 1, this.viewportHeight = 1, this.resolution = new Gi(), this.dummyCamera = new A2(), this.sceneTransitionDuration = 0, this.sceneTransitionTimeRemaining = -1, this.manageShadowUpdates = false, this.forceShadowUpdates = false, this.clear = (e2 = true, t4 = true, n4 = true) => {
  ...
  renderNormal(e2, t3, n3) {
    if (this.normalRenderTarget) {
      ...
      }), this.setRenderTarget(this.normalRenderTarget), this.clear(), Zl.value = n3 instanceof A2 ? (n3.far - n3.near) / 1e4 : 1;
  ...
  renderSplineScene(e2, t3, { sceneHelpers: a4 = this.sceneHelpers, sceneHelpersOnTop: o2 = this.sceneHelpersOnTop, overrideTransmission: u3, overrideNormal: f3 } = {}) {
    ...
    }), this.manageShadowUpdates && (this.shadowMap.autoUpdate = false, (m2.shadowsDirty || this.forceShadowUpdates) && (this.shadowMap.needsUpdate = true)), p2.overrideMaterial = m2.wireframeState ? xe2 : null, this.pipeline.render(), this.manageShadowUpdates && (m2.shadowsDirty = false), Zs.taaEnabled.value && (Zs.frameIndex.value = (Zs.frameIndex.value + 1) % 16), t3 instanceof A2 && t3.copyHistory(), p2.visible = h3;
  }
...
//# sourceMappingURL=runtime-classicRuntime-PSJWHR3W-RQVTGFKP.js.map
