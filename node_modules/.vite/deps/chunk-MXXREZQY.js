...
import {
  e as e2
} from "./chunk-RIILFETX.js";
import {
  r as r2
} from "./chunk-P4XWSAPW.js";
import {
  G,
  R,
  X,
...
import {
  i as i2,
  s as s3
} from "./chunk-3TSVGU2M.js";
import {
  c as c3
} from "./chunk-2JIYK4WS.js";
import {
  l
} from "./chunk-YJIF3N4N.js";
import {
  Xt,
  ar,
  cr,
...
// node_modules/@splinetool/runtime/build/runtime-chunk-TGOKOORP.js
var St = null;
function Bt(t2) {
  St = t2;
}
...
function Et(t2) {
  let e3 = Dt2.get(t2);
  return void 0 === e3 && (e3 = Rt2++, Dt2.set(t2, e3)), e3;
}
function Ot2(t2, e3, n3, s4) {
  var _a;
  let i3 = t2, r4 = e3;
  return [Et(n3), Et(s4), ((_a = i3.layers) == null ? void 0 : _a.mask) ?? 0, i3.renderOrder ?? 0, true === (i3.castShadow ?? r4.castShadow) ? 1 : 0, true === (i3.receiveShadow ?? r4.receiveShadow) ? 1 : 0].join(":");
}
var zt2 = [8, 32, 128, 512];
var jt2 = zt2[zt2.length - 1];
...
var Ut = class {
    ...
    t2.traverse((t3) => {
      ...
      let s5 = function(t4) {
        ...
        return null != r4.positionNode || null != r4.castShadowPositionNode ? "position-node" : true === r4.transparent ? "transparent" : void 0 !== ((_a = e4.userData) == null ? void 0 : _a.__splinePlanarMirror) ? "reflection" : function(t5) {
          ...
          return false;
        }(e4) ? "interaction-states" : { object: t4, owner: e4, geometry: s6, material: n4, key: Ot2(t4, e4, s6, n4) };
      }(t3);
  ...
  createGroup(t2, e3, n3) {
    let s4 = n3[0], i3 = new Tt2(s4.geometry, s4.material, function(t3) {
      for (let e4 of zt2) if (t3 <= e4) return e4;
      return jt2;
    }(n3.length), s4.object);
...
var Yt = class extends Za {
  ...
  static buildMesh(t2, e3, n3 = false, s4 = 1, i3, r4) {
    let a3 = Yt.buildGeomtery(e3), o2 = Yt.buildMaterial(i3);
    return new Yt(t2, e3, a3, o2, n3, s4, i3, r4);
  }
  ...
  allocateAndStoreLocalSplatDataInTextures() {
    ...
    for (let e4 = 0; e4 < t2; e4++) {
      ...
      r4[s5] = Ft(this.colors[t3], this.colors[t3 + 1], this.colors[t3 + 2], this.colors[t3 + 3]), r4[s5 + 1] = Nt(this.centers[n4]), r4[s5 + 2] = Nt(this.centers[n4 + 1]), r4[s5 + 3] = Nt(this.centers[n4 + 2]);
    }
...
var Xt2 = false;
function Zt() {
  if (!Xt2) return Qt || (Qt = async function() {
    let t2 = await import("./gaussian-splat-compression-EODMSXHV.js");
    Lt(t2), Xt2 = true;
  }());
}
var Kt = new As();
...
function re(t2, e3, n3, s4, i3, r4, a3, o2, l2) {
  ...
  Kt.copy(t2.objectToDecal), Ht.getNormalMatrix(Kt);
  let y2 = [], g = [];
  for (let t3 = m; t3 + 2 < f2; t3 += 3) {
    let d3 = null !== p3 ? p3.getX(t3) : t3, u2 = null !== p3 ? p3.getX(t3 + 1) : t3 + 1, m2 = null !== p3 ? p3.getX(t3 + 2) : t3 + 2;
    if (Jt.fromBufferAttribute(c4, d3).applyMatrix4(Kt), $t.fromBufferAttribute(c4, u2).applyMatrix4(Kt), te.fromBufferAttribute(c4, m2).applyMatrix4(Kt), Jt.z > n3 && $t.z > n3 && te.z > n3 || Jt.z < -n3 && $t.z < -n3 && te.z < -n3) continue;
    ee2.subVectors($t, Jt), ne.subVectors(te, Jt), se.crossVectors(ee2, ne);
    let f3 = se.length();
    if (!(0 === f3 || se.z / f3 <= 0.01)) {
      if (y2.length = 0, void 0 !== h) ee2.fromBufferAttribute(h, d3).applyMatrix3(Ht), y2.push({ px: Jt.x, py: Jt.y, pz: Jt.z, nx: ee2.x, ny: ee2.y, nz: ee2.z }), ee2.fromBufferAttribute(h, u2).applyMatrix3(Ht), y2.push({ px: $t.x, py: $t.y, pz: $t.z, nx: ee2.x, ny: ee2.y, nz: ee2.z }), ee2.fromBufferAttribute(h, m2).applyMatrix3(Ht), y2.push({ px: te.x, py: te.y, pz: te.z, nx: ee2.x, ny: ee2.y, nz: ee2.z });
      else {
        se.divideScalar(f3);
...
var ce = class extends ar {
  ...
  updateByPatchedOp(t2, e3, n3) {
    super.updateByPatchedOp(t2, e3, n3), V(t2.path, ["geometry"]) && this.resetBBoxNeedsUpdate();
  }
...
function ue(n3, s4, i3) {
  ...
  if ("Page" === s4.type) return new X(n3, s4, i3);
  ...
  return nt.is(s4.type) ? new A(n3, s4) : (console.error(s4), new r2(n3, s4));
}
...
var ge = class {
  ...
  setupSplatMesh(t2, e3, n3 = new Ki(), s4 = new Qi(), i3 = false, r4 = 1, a3, o2) {
    this.splatMesh = Yt.buildMesh(t2, e3, i3, r4, a3, o2), this.splatMesh.position.copy(n3), this.splatMesh.quaternion.copy(s4), this.splatMesh.frustumCulled = false, this.splatMesh.renderOrder = 99999, this.splatRenderCount = e3, this.splatMesh.onBeforeRender = (t3, e4, n4) => this.update(t3, n4);
  }
  setupSortWorker(t2) {
...
var Ae = class extends hr {
  ...
  needsTransmission() {
    return this.needsTransmissionDirty && (this._needsTransmission = G(this), this.needsTransmissionDirty = false), this._needsTransmission;
  }
  needsNormal() {
    return this.needsNormalDirty && (this._normalPassNeeds = _(this), this._needsNormal = this._normalPassNeeds.outline || this._normalPassNeeds.cavity, this.needsNormalDirty = false), this._needsNormal;
  }
  normalPassNeeds() {
  ...
  markPenumbraSizeDirty() {
    for (let t2 of this.children) t2 instanceof X && (t2.penumbraSizeArrayCache = null);
  }
  findInstance(t2) {
  ...
  find2D(t2) {
    for (let e3 of this.children) if (e3 instanceof X && e3.uiScene) {
      let n3 = e3.uiScene.find(t2);
      if (n3) return n3;
    }
  }
  findScene2DfromObject2D(t2) {
    for (let e3 of this.children) if (e3 instanceof X && e3.uiScene && e3.uiScene.find(t2)) return e3.uiScene;
  }
  ...
  traverse2D(t2) {
    for (let e3 of this.children) e3 instanceof X && e3.uiScene && e3.uiScene.traverse(t2);
  }
  ...
  updatePage(t2) {
    ...
    for (let e3 of this.children) e3 instanceof X && (e3.visible = e3.uuid === t2, e3.visible && (this.activePage = e3, this.activePage.onActive(this)));
  ...
  updateEntity2DByOp(t2, e3, n3, s4, i3, r4 = []) {
    t2.updateEntityByOp(e3, n3, s4, i3), this.traverseEntity((t3) => {
      (s(t3) || t3 instanceof X) && (r4.includes(t3.frameId ?? "") || t3.frameId === e3) && t3.updateEntity2DByOp(e3, n3, s4, i3);
    });
  }
  get activeCamera() {
  ...
  rewriteActions(t2, e3, n3, s4, i3, r4) {
    t2.forEach((t3) => {
      "Transition" === t3.data.type || "Animation" === t3.data.type ? this.relativeizeInner(t3.data.object, [...e3, t3.id], "object", n3, s4, i3, r4) : "Conditional" === t3.data.type && (this.rewriteActions(t3.data.ifActions, [...e3, t3.id, "ifActions"], n3, s4, i3, r4), this.rewriteActions(t3.data.elseActions, [...e3, t3.id, "elseActions"], n3, s4, i3, r4));
    });
  }
  ...
  raycast1(t2, e3) {
    let n3 = [], s4 = (i3) => {
      for (let a3 of i3.children) {
        ...
        } else (T(a3) || k(a3) && this.enableHelpers && a3.objectHelper.visible) && (t2.intersectObject(a3, false, n3), Z(a3, t2, n3)), s4(a3);
      }
    };
  ...
  raycastWithClones(t2) {
    let e3 = [], n3 = (s4) => {
      for (let i3 of s4.children) {
        let s5 = i3.cloner;
        mt.is(i3) && (i3.visible || (s5 == null ? void 0 : s5.object.data.visible)) && ((T(i3) || k(i3) && this.enableHelpers && i3.objectHelper.visible) && (t2.intersectObject(i3, false, e3), Z(i3, t2, e3, true)), n3(i3));
      }
    };
    return n3(this), e3;
  }
  ...
  traverseObject(t2) {
    for (let e3 of this.children) K.is(e3) && e3.traverseObject(t2);
  }
  ...
  updateViewPlaneSize(t2, e3, n3 = false) {
    this.traverseConcreteEntity((s4) => {
      s4 instanceof A && s4.setViewplaneSize(t2, e3, n3);
    });
  }
...
//# sourceMappingURL=chunk-MXXREZQY.js.map
