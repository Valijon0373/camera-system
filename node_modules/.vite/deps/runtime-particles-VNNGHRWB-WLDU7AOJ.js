...
// node_modules/@splinetool/runtime/build/runtime-particles-VNNGHRWB.js
var N = new Mr();
var O = new Ki();
var U = new Gi();
var L = new Gi();
...
var W = class {
  ...
  createPositions(e, t2) {
    ...
    return { dataTexture: B(i, e), positions: i, dataTextureNormals: B(n2, e) };
  }
  getMesh(e, t2) {
    let i = null;
    switch (e) {
...
var j = class extends ie {
  ...
  updateByPatchedOp(e, t2, i) {
    super.updateByPatchedOp(e, t2, i), V(e.path, ["renderMaterial"]) && this.updateParticleState({ renderMaterial: { ...this.data.renderMaterial, ...E.drop(e, 1).props } }), V(e.path, ["shape"]) && this.updateParticleState({ shape: { ...this.data.shape, ...E.drop(e, 1).props } });
  }
  updateState(e, t2) {
...
//# sourceMappingURL=runtime-particles-VNNGHRWB-WLDU7AOJ.js.map
